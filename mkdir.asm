...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 52 08 00 	movl   $0x852,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	0f b6 90 b4 0a 00 00 	movzbl 0xab4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 56d:	75 27                	jne    596 <printf+0x11f>
          s = "(null)";
 56f:	c7 45 f4 6e 08 00 00 	movl   $0x86e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63b:	a1 d0 0a 00 00       	mov    0xad0,%eax
...
free(void *ap)
{
 ...
 6fc:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 701:	c9                   	leave  
 702:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 74f:	e8 d8 fe ff ff       	call   62c <free>
  return freep;
 754:	a1 d0 0a 00 00       	mov    0xad0,%eax
}
 759:	c9                   	leave  
 75a:	c3                   	ret    
