...
8010003a:	c7 44 24 04 6c 92 10 	movl   $0x8010926c,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 28 5b 00 00       	call   80105b76 <initlock>
...
801000bd:	e8 d5 5a 00 00       	call   80105b97 <acquire>
...
80100104:	e8 f0 5a 00 00       	call   80105bf9 <release>
        return b;
...
8010017c:	e8 78 5a 00 00       	call   80105bf9 <release>
      return b;
...
80100198:	c7 04 24 73 92 10 80 	movl   $0x80109273,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 84 92 10 80 	movl   $0x80109284,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 8b 92 10 80 	movl   $0x8010928b,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 56 59 00 00       	call   80105b97 <acquire>
...
801002a9:	e8 4b 59 00 00       	call   80105bf9 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 d6 57 00 00       	call   80105b97 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 92 92 10 80 	movl   $0x80109292,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 9b 92 10 80 	movl   $0x8010929b,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 be 56 00 00       	call   80105bf9 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 a2 92 10 80 	movl   $0x801092a2,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 b1 92 10 80 	movl   $0x801092b1,(%esp)
...
80100592:	e8 b1 56 00 00       	call   80105c48 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 b3 92 10 80 	movl   $0x801092b3,(%esp)
...
801006e2:	e8 d2 57 00 00       	call   80105eb9 <memmove>
  startingPos++;
...
801007dc:	e8 d8 56 00 00       	call   80105eb9 <memmove>
...
80100810:	e8 4f 58 00 00       	call   80106064 <strlen>
...
80100831:	e8 2e 58 00 00       	call   80106064 <strlen>
...
801008b7:	e8 fd 55 00 00       	call   80105eb9 <memmove>
...
801008eb:	e8 74 57 00 00       	call   80106064 <strlen>
...
8010090c:	e8 53 57 00 00       	call   80106064 <strlen>
...
8010098b:	e8 29 55 00 00       	call   80105eb9 <memmove>
        endPos--;
...
801009e7:	e8 cd 54 00 00       	call   80105eb9 <memmove>
    pos -= 80;
...
80100a16:	e8 cb 53 00 00       	call   80105de6 <memset>
  }
...
80100bbc:	e8 d6 4f 00 00       	call   80105b97 <acquire>
  while((c = getc()) >= 0){
...
80100e51:	e8 0e 52 00 00       	call   80106064 <strlen>
...
80100f2f:	e8 30 51 00 00       	call   80106064 <strlen>
...
80101139:	e8 bb 4a 00 00       	call   80105bf9 <release>
}
...
80101162:	e8 30 4a 00 00       	call   80105b97 <acquire>
  while(n > 0){
...
80101180:	e8 74 4a 00 00       	call   80105bf9 <release>
        ilock(ip);
...
80101227:	e8 cd 49 00 00       	call   80105bf9 <release>
  ilock(ip);
...
8010125d:	e8 35 49 00 00       	call   80105b97 <acquire>
  for(i = 0; i < n; i++)
...
80101297:	e8 5d 49 00 00       	call   80105bf9 <release>
  ilock(ip);
...
801012b2:	c7 44 24 04 b7 92 10 	movl   $0x801092b7,0x4(%esp)
801012b9:	80 
801012ba:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
801012c1:	e8 b0 48 00 00       	call   80105b76 <initlock>
  initlock(&input.lock, "input");
801012c6:	c7 44 24 04 bf 92 10 	movl   $0x801092bf,0x4(%esp)
801012cd:	80 
801012ce:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
801012d5:	e8 9c 48 00 00       	call   80105b76 <initlock>
...
80101398:	0f 85 44 03 00 00    	jne    801016e2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
8010139e:	e8 5e 76 00 00       	call   80108a01 <setupkvm>
...
80101437:	e8 97 79 00 00       	call   80108dd3 <allocuvm>
...
80101474:	e8 6b 78 00 00       	call   80108ce4 <loaduvm>
...
801014e4:	e8 ea 78 00 00       	call   80108dd3 <allocuvm>
...
80101508:	e8 ea 7a 00 00       	call   80108ff7 <clearpteu>
  sp = sz;
...
80101537:	e8 28 4b 00 00       	call   80106064 <strlen>
...
80101555:	e8 0a 4b 00 00       	call   80106064 <strlen>
...
8010157f:	e8 38 7c 00 00       	call   801091bc <copyout>
...
8010161f:	e8 98 7b 00 00       	call   801091bc <copyout>
...
80101676:	e8 9b 49 00 00       	call   80106016 <safestrcpy>
...
801016c8:	e8 25 74 00 00       	call   80108af2 <switchuvm>
  freevm(oldpgdir);
801016cd:	8b 45 d0             	mov    -0x30(%ebp),%eax
801016d0:	89 04 24             	mov    %eax,(%esp)
801016d3:	e8 91 78 00 00       	call   80108f69 <freevm>
  return 0;
...
8010170a:	e8 5a 78 00 00       	call   80108f69 <freevm>
  if(ip){
...
80101732:	c7 44 24 04 c5 92 10 	movl   $0x801092c5,0x4(%esp)
80101739:	80 
8010173a:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
80101741:	e8 30 44 00 00       	call   80105b76 <initlock>
}
80101746:	c9                   	leave  
80101747:	c3                   	ret    
...
80101755:	e8 3d 44 00 00       	call   80105b97 <acquire>
...
8010177e:	e8 76 44 00 00       	call   80105bf9 <release>
      return f;
...
8010179c:	e8 58 44 00 00       	call   80105bf9 <release>
  return 0;
...
801017b5:	e8 dd 43 00 00       	call   80105b97 <acquire>
  if(f->ref < 1)
...
801017c2:	7f 0c                	jg     801017d0 <filedup+0x28>
    panic("filedup");
801017c4:	c7 04 24 cc 92 10 80 	movl   $0x801092cc,(%esp)
...
801017e6:	e8 0e 44 00 00       	call   80105bf9 <release>
  return f;
...
801017fd:	e8 95 43 00 00       	call   80105b97 <acquire>
  if(f->ref < 1)
...
8010180a:	7f 0c                	jg     80101818 <fileclose+0x28>
    panic("fileclose");
8010180c:	c7 04 24 d4 92 10 80 	movl   $0x801092d4,(%esp)
...
80101838:	e8 bc 43 00 00       	call   80105bf9 <release>
    return;
...
80101882:	e8 72 43 00 00       	call   80105bf9 <release>
...
801019c1:	eb 0c                	jmp    801019cf <fileread+0xba>
  ...
  panic("fileread");
801019c3:	c7 04 24 de 92 10 80 	movl   $0x801092de,(%esp)
...
80101acf:	c7 04 24 e7 92 10 80 	movl   $0x801092e7,(%esp)
...
80101b02:	eb 0c                	jmp    80101b10 <filewrite+0x13f>
  ...
  panic("filewrite");
80101b04:	c7 04 24 f7 92 10 80 	movl   $0x801092f7,(%esp)
...
80101b4c:	e8 68 43 00 00       	call   80105eb9 <memmove>
  brelse(bp);
...
80101b92:	e8 4f 42 00 00       	call   80105de6 <memset>
  log_write(bp);
...
80101ce4:	0f 82 df fe ff ff    	jb     80101bc9 <balloc+0x1a>
  ...
  panic("balloc: out of blocks");
80101cea:	c7 04 24 04 93 10 80 	movl   $0x80109304,(%esp)
...
80101d7e:	c7 04 24 1a 93 10 80 	movl   $0x8010931a,(%esp)
...
80101dd5:	c7 44 24 04 2d 93 10 	movl   $0x8010932d,0x4(%esp)
80101ddc:	80 
80101ddd:	c7 04 24 80 2a 11 80 	movl   $0x80112a80,(%esp)
80101de4:	e8 8d 3d 00 00       	call   80105b76 <initlock>
  readsb(dev, &sb);
...
80101e4c:	c7 04 24 34 93 10 80 	movl   $0x80109334,(%esp)
...
80101ecf:	e8 12 3f 00 00       	call   80105de6 <memset>
      dip->type = type;
...
80101f21:	0f 82 52 ff ff ff    	jb     80101e79 <ialloc+0x19>
  ...
  panic("ialloc: no inodes");
80101f27:	c7 04 24 87 93 10 80 	movl   $0x80109387,(%esp)
...
80101fd4:	e8 e0 3e 00 00       	call   80105eb9 <memmove>
  log_write(bp);
...
80101ffe:	e8 94 3b 00 00       	call   80105b97 <acquire>
...
80102048:	e8 ac 3b 00 00       	call   80105bf9 <release>
      return ip;
...
8010207b:	c7 04 24 99 93 10 80 	movl   $0x80109399,(%esp)
...
801020b9:	e8 3b 3b 00 00       	call   80105bf9 <release>
...
801020d0:	e8 c2 3a 00 00       	call   80105b97 <acquire>
  ip->ref++;
...
801020eb:	e8 09 3b 00 00       	call   80105bf9 <release>
  return ip;
...
80102109:	7f 0c                	jg     80102117 <ilock+0x22>
    panic("ilock");
8010210b:	c7 04 24 a9 93 10 80 	movl   $0x801093a9,(%esp)
80102112:	e8 26 e4 ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80102117:	c7 04 24 80 2a 11 80 	movl   $0x80112a80,(%esp)
8010211e:	e8 74 3a 00 00       	call   80105b97 <acquire>
...
8010215d:	e8 97 3a 00 00       	call   80105bf9 <release>
...
8010220e:	e8 a6 3c 00 00       	call   80105eb9 <memmove>
    brelse(bp);
...
80102239:	75 0c                	jne    80102247 <ilock+0x152>
      panic("ilock: no type");
8010223b:	c7 04 24 af 93 10 80 	movl   $0x801093af,(%esp)
...
8010226a:	7f 0c                	jg     80102278 <iunlock+0x2f>
    panic("iunlock");
8010226c:	c7 04 24 be 93 10 80 	movl   $0x801093be,(%esp)
80102273:	e8 c5 e2 ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80102278:	c7 04 24 80 2a 11 80 	movl   $0x80112a80,(%esp)
8010227f:	e8 13 39 00 00       	call   80105b97 <acquire>
  ip->flags &= ~I_BUSY;
...
801022a7:	e8 4d 39 00 00       	call   80105bf9 <release>
}
801022ac:	c9                   	leave  
801022ad:	c3                   	ret    
...
801022bb:	e8 d7 38 00 00       	call   80105b97 <acquire>
...
801022f7:	74 0c                	je     80102305 <iput+0x57>
      panic("iput busy");
801022f9:	c7 04 24 c6 93 10 80 	movl   $0x801093c6,(%esp)
...
8010231d:	e8 d7 38 00 00       	call   80105bf9 <release>
    itrunc(ip);
...
80102348:	e8 4a 38 00 00       	call   80105b97 <acquire>
    ip->flags = 0;
...
80102378:	e8 7c 38 00 00       	call   80105bf9 <release>
}
8010237d:	c9                   	leave  
8010237e:	c3                   	ret    
...
8010248d:	c7 04 24 d0 93 10 80 	movl   $0x801093d0,(%esp)
...
80102725:	e8 8f 37 00 00       	call   80105eb9 <memmove>
    brelse(bp);
...
8010288b:	e8 29 36 00 00       	call   80105eb9 <memmove>
    log_write(bp);
...
8010290d:	e8 4b 36 00 00       	call   80105f5d <strncmp>
}
80102912:	c9                   	leave  
80102913:	c3                   	ret    
...
80102927:	c7 04 24 e3 93 10 80 	movl   $0x801093e3,(%esp)
...
80102963:	74 0c                	je     80102971 <dirlookup+0x5d>
      panic("dirlink read");
80102965:	c7 04 24 f5 93 10 80 	movl   $0x801093f5,(%esp)
...
80102a47:	74 0c                	je     80102a55 <dirlink+0x79>
      panic("dirlink read");
80102a49:	c7 04 24 f5 93 10 80 	movl   $0x801093f5,(%esp)
...
80102a8f:	e8 21 35 00 00       	call   80105fb5 <strncpy>
  de.inum = inum;
...
80102abf:	74 0c                	je     80102acd <dirlink+0xf1>
    panic("dirlink");
80102ac1:	c7 04 24 02 94 10 80 	movl   $0x80109402,(%esp)
...
80102b48:	e8 6c 33 00 00       	call   80105eb9 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
80102b63:	e8 51 33 00 00       	call   80105eb9 <memmove>
    name[len] = 0;
...
80102dc0:	c7 44 24 04 0a 94 10 	movl   $0x8010940a,0x4(%esp)
80102dc7:	80 
80102dc8:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80102dcf:	e8 a2 2d 00 00       	call   80105b76 <initlock>
  picenable(IRQ_IDE);
...
80102e6a:	75 0c                	jne    80102e78 <idestart+0x18>
    panic("idestart");
80102e6c:	c7 04 24 0e 94 10 80 	movl   $0x8010940e,(%esp)
...
80102e85:	c7 04 24 17 94 10 80 	movl   $0x80109417,(%esp)
...
80102ead:	c7 04 24 0e 94 10 80 	movl   $0x8010940e,(%esp)
...
80102fc9:	e8 c9 2b 00 00       	call   80105b97 <acquire>
  if((b = idequeue) == 0){
...
80102fe3:	e8 11 2c 00 00       	call   80105bf9 <release>
...
80103078:	e8 7c 2b 00 00       	call   80105bf9 <release>
}
8010307d:	c9                   	leave  
8010307e:	c3                   	ret    
...
80103091:	c7 04 24 29 94 10 80 	movl   $0x80109429,(%esp)
...
801030aa:	c7 04 24 3d 94 10 80 	movl   $0x8010943d,(%esp)
...
80103151:	e8 a3 2a 00 00       	call   80105bf9 <release>
}
80103156:	c9                   	leave  
80103157:	c3                   	ret    
...
801031de:	c7 04 24 70 94 10 80 	movl   $0x80109470,(%esp)
...
8010329f:	c7 44 24 04 a2 94 10 	movl   $0x801094a2,0x4(%esp)
801032a6:	80 
801032a7:	c7 04 24 60 3a 11 80 	movl   $0x80113a60,(%esp)
801032ae:	e8 c3 28 00 00       	call   80105b76 <initlock>
  kmem.use_lock = 0;
...
80103359:	76 0c                	jbe    80103367 <kfree+0x39>
    panic("kfree");
8010335b:	c7 04 24 a7 94 10 80 	movl   $0x801094a7,(%esp)
...
8010337d:	e8 64 2a 00 00       	call   80105de6 <memset>
...
80103392:	e8 00 28 00 00       	call   80105b97 <acquire>
  r = (struct run*)v;
...
801033c0:	e8 34 28 00 00       	call   80105bf9 <release>
}
801033c5:	c9                   	leave  
801033c6:	c3                   	ret    
...
801033dd:	e8 b5 27 00 00       	call   80105b97 <acquire>
  r = kmem.freelist;
...
8010340a:	e8 ea 27 00 00       	call   80105bf9 <release>
  return (char*)r;
...
801037b0:	c7 04 24 b0 94 10 80 	movl   $0x801094b0,(%esp)
...
80103a14:	e8 44 24 00 00       	call   80105e5d <memcmp>
...
80103b16:	c7 44 24 04 dc 94 10 	movl   $0x801094dc,0x4(%esp)
80103b1d:	80 
80103b1e:	c7 04 24 a0 3a 11 80 	movl   $0x80113aa0,(%esp)
80103b25:	e8 4c 20 00 00       	call   80105b76 <initlock>
  readsb(dev, &sb);
...
80103bcc:	e8 e8 22 00 00       	call   80105eb9 <memmove>
...
80103d1e:	e8 74 1e 00 00       	call   80105b97 <acquire>
  while(1){
    if(log.committing){
...
80103d8a:	e8 6a 1e 00 00       	call   80105bf9 <release>
      break;
80103d8f:	90                   	nop
    }
  }
...
80103da6:	e8 ec 1d 00 00       	call   80105b97 <acquire>
  log.outstanding -= 1;
...
80103dc1:	c7 04 24 e0 94 10 80 	movl   $0x801094e0,(%esp)
...
80103dfc:	e8 f8 1d 00 00       	call   80105bf9 <release>
...
80103e13:	e8 7f 1d 00 00       	call   80105b97 <acquire>
    log.committing = 0;
...
80103e35:	e8 bf 1d 00 00       	call   80105bf9 <release>
  }
}
80103e3a:	c9                   	leave  
80103e3b:	c3                   	ret    
...
80103ead:	e8 07 20 00 00       	call   80105eb9 <memmove>
...
80103f38:	c7 04 24 ef 94 10 80 	movl   $0x801094ef,(%esp)
...
80103f4d:	c7 04 24 05 95 10 80 	movl   $0x80109505,(%esp)
80103f54:	e8 e4 c5 ff ff       	call   8010053d <panic>

  acquire(&log.lock);
80103f59:	c7 04 24 a0 3a 11 80 	movl   $0x80113aa0,(%esp)
80103f60:	e8 32 1c 00 00       	call   80105b97 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103fd8:	e8 1c 1c 00 00       	call   80105bf9 <release>
}
80103fdd:	c9                   	leave  
80103fde:	c3                   	ret    
	...
...
80104060:	c7 04 24 20 95 10 80 	movl   $0x80109520,(%esp)
...
8010407b:	e8 2c 37 00 00       	call   801077ac <uartinit>
  pinit();         // process table
80104080:	e8 8a 0b 00 00       	call   80104c0f <pinit>
  tvinit();        // trap vectors
80104085:	e8 9d 32 00 00       	call   80107327 <tvinit>
  binit();         // buffer cache
...
801040a2:	e8 c3 31 00 00       	call   8010726a <timerinit>
...
801040cd:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801040d0:	e8 00 4a 00 00       	call   80108ad5 <switchkvm>
  seginit();
801040d5:	e8 87 43 00 00       	call   80108461 <seginit>
  lapicinit();
...
801040fa:	c7 04 24 37 95 10 80 	movl   $0x80109537,(%esp)
80104101:	e8 9b c2 ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80104106:	e8 90 33 00 00       	call   8010749b <idtinit>
...
80104158:	e8 5c 1d 00 00       	call   80105eb9 <memmove>
...
801042e7:	00 
801042e8:	c7 44 24 04 48 95 10 	movl   $0x80109548,0x4(%esp)
801042ef:	80 
801042f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042f3:	89 04 24             	mov    %eax,(%esp)
801042f6:	e8 62 1b 00 00       	call   80105e5d <memcmp>
...
80104428:	00 
80104429:	c7 44 24 04 4d 95 10 	movl   $0x8010954d,0x4(%esp)
80104430:	80 
80104431:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104434:	89 04 24             	mov    %eax,(%esp)
80104437:	e8 21 1a 00 00       	call   80105e5d <memcmp>
...
80104502:	8b 04 85 90 95 10 80 	mov    -0x7fef6a70(,%eax,4),%eax
...
8010453b:	c7 04 24 52 95 10 80 	movl   $0x80109552,(%esp)
...
801045ce:	c7 04 24 70 95 10 80 	movl   $0x80109570,(%esp)
...
801048d3:	c7 44 24 04 a4 95 10 	movl   $0x801095a4,0x4(%esp)
801048da:	80 
801048db:	89 04 24             	mov    %eax,(%esp)
801048de:	e8 93 12 00 00       	call   80105b76 <initlock>
  (*f0)->type = FD_PIPE;
...
8010498b:	e8 07 12 00 00       	call   80105b97 <acquire>
  if(writable){
...
801049f2:	e8 02 12 00 00       	call   80105bf9 <release>
    kfree((char*)p);
...
80104a0a:	e8 ea 11 00 00       	call   80105bf9 <release>
}
80104a0f:	c9                   	leave  
80104a10:	c3                   	ret    
...
80104a1e:	e8 74 11 00 00       	call   80105b97 <acquire>
  for(i = 0; i < n; i++){
...
80104a4f:	e8 a5 11 00 00       	call   80105bf9 <release>
        return -1;
...
80104af3:	e8 01 11 00 00       	call   80105bf9 <release>
  return n;
...
80104b0e:	e8 84 10 00 00       	call   80105b97 <acquire>
...
80104b28:	e8 cc 10 00 00       	call   80105bf9 <release>
      return -1;
...
80104be5:	e8 0f 10 00 00       	call   80105bf9 <release>
  return i;
...
80104c15:	c7 44 24 04 a9 95 10 	movl   $0x801095a9,0x4(%esp)
80104c1c:	80 
80104c1d:	c7 04 24 a0 41 11 80 	movl   $0x801141a0,(%esp)
80104c24:	e8 4d 0f 00 00       	call   80105b76 <initlock>
}
80104c29:	c9                   	leave  
80104c2a:	c3                   	ret    
...
80104c38:	e8 5a 0f 00 00       	call   80105b97 <acquire>
...
80104c67:	e8 8d 0f 00 00       	call   80105bf9 <release>
  return 0;
...
80104ca8:	e8 4c 0f 00 00       	call   80105bf9 <release>
...
80104cf2:	ba dc 72 10 80       	mov    $0x801072dc,%edx
...
80104d22:	e8 bf 10 00 00       	call   80105de6 <memset>
...
80104d50:	e8 ac 3c 00 00       	call   80108a01 <setupkvm>
...
80104d65:	c7 04 24 b0 95 10 80 	movl   $0x801095b0,(%esp)
...
80104d8b:	e8 c9 3e 00 00       	call   80108c59 <inituvm>
  p->sz = PGSIZE;
...
80104db2:	e8 2f 10 00 00       	call   80105de6 <memset>
...
80104e2b:	00 
80104e2c:	c7 44 24 04 c9 95 10 	movl   $0x801095c9,0x4(%esp)
80104e33:	80 
80104e34:	89 04 24             	mov    %eax,(%esp)
80104e37:	e8 da 11 00 00       	call   80106016 <safestrcpy>
  p->cwd = namei("/");
80104e3c:	c7 04 24 d2 95 10 80 	movl   $0x801095d2,(%esp)
...
80104e90:	e8 3e 3f 00 00       	call   80108dd3 <allocuvm>
...
80104eca:	e8 de 3f 00 00       	call   80108ead <deallocuvm>
...
80104ef3:	e8 fa 3b 00 00       	call   80108af2 <switchuvm>
  return 0;
...
80104f38:	e8 00 41 00 00       	call   8010903d <copyuvm>
...
8010507b:	e8 96 0f 00 00       	call   80106016 <safestrcpy>
...
80105090:	e8 02 0b 00 00       	call   80105b97 <acquire>
  np->state = RUNNABLE;
...
801050a6:	e8 4e 0b 00 00       	call   80105bf9 <release>
...
801050ca:	75 0c                	jne    801050d8 <exit+0x22>
    panic("init exiting");
801050cc:	c7 04 24 d4 95 10 80 	movl   $0x801095d4,(%esp)
...
8010515a:	e8 38 0a 00 00       	call   80105b97 <acquire>
...
801051ca:	e8 bd 03 00 00       	call   8010558c <sched>
  panic("zombie exit");
801051cf:	c7 04 24 e1 95 10 80 	movl   $0x801095e1,(%esp)
...
801051e8:	e8 aa 09 00 00       	call   80105b97 <acquire>
  for(;;){
...
80105250:	e8 14 3d 00 00       	call   80108f69 <freevm>
        p->state = UNUSED;
...
8010528b:	e8 69 09 00 00       	call   80105bf9 <release>
        return pid;
...
801052c4:	e8 30 09 00 00       	call   80105bf9 <release>
      return -1;
...
801052ff:	e8 93 08 00 00       	call   80105b97 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80105327:	e8 c6 37 00 00       	call   80108af2 <switchuvm>
      p->state = RUNNING;
...
80105350:	e8 37 0d 00 00       	call   8010608c <swtch>
      switchkvm();
80105355:	e8 7b 37 00 00       	call   80108ad5 <switchkvm>
...
8010537f:	e8 75 08 00 00       	call   80105bf9 <release>
...
8010539b:	e8 f7 07 00 00       	call   80105b97 <acquire>
    chosenProc=0;
...
801053f4:	e8 00 08 00 00       	call   80105bf9 <release>
     continue;
801053f9:	90                   	nop
...
8010540d:	e8 e0 36 00 00       	call   80108af2 <switchuvm>
...
80105436:	e8 51 0c 00 00       	call   8010608c <swtch>
      switchkvm();
8010543b:	e8 95 36 00 00       	call   80108ad5 <switchkvm>
    // to release ptable.lock and then reacquire it
    // before jumping back to us.
    proc=chosenProc;
...
80105460:	e8 94 07 00 00       	call   80105bf9 <release>
  }
...
8010548a:	e8 08 07 00 00       	call   80105b97 <acquire>
...
801054f6:	e8 f7 35 00 00       	call   80108af2 <switchuvm>
      p->state = RUNNING;
...
8010551f:	e8 68 0b 00 00       	call   8010608c <swtch>
      switchkvm();
80105524:	e8 ac 35 00 00       	call   80108ad5 <switchkvm>
...
8010556c:	e8 88 06 00 00       	call   80105bf9 <release>
...
80105599:	e8 17 07 00 00       	call   80105cb5 <holding>
8010559e:	85 c0                	test   %eax,%eax
801055a0:	75 0c                	jne    801055ae <sched+0x22>
    panic("sched ptable.lock");
801055a2:	c7 04 24 ed 95 10 80 	movl   $0x801095ed,(%esp)
...
801055bd:	74 0c                	je     801055cb <sched+0x3f>
    panic("sched locks");
801055bf:	c7 04 24 ff 95 10 80 	movl   $0x801095ff,(%esp)
...
801055d7:	75 0c                	jne    801055e5 <sched+0x59>
    panic("sched running");
801055d9:	c7 04 24 0b 96 10 80 	movl   $0x8010960b,(%esp)
...
801055f3:	c7 04 24 19 96 10 80 	movl   $0x80109619,(%esp)
...
80105628:	e8 5f 0a 00 00       	call   8010608c <swtch>
  cpu->intena = intena;
...
8010564b:	e8 47 05 00 00       	call   80105b97 <acquire>
  proc->state = RUNNABLE;
...
80105669:	e8 8b 05 00 00       	call   80105bf9 <release>
}
8010566e:	c9                   	leave  
8010566f:	c3                   	ret    
...
8010567d:	e8 77 05 00 00       	call   80105bf9 <release>
...
801056bd:	75 0c                	jne    801056cb <sleep+0x1c>
    panic("sleep");
801056bf:	c7 04 24 2d 96 10 80 	movl   $0x8010962d,(%esp)
...
801056d1:	c7 04 24 33 96 10 80 	movl   $0x80109633,(%esp)
...
801056ed:	e8 a5 04 00 00       	call   80105b97 <acquire>
    release(lk);
801056f2:	8b 45 0c             	mov    0xc(%ebp),%eax
801056f5:	89 04 24             	mov    %eax,(%esp)
801056f8:	e8 fc 04 00 00       	call   80105bf9 <release>
  }
...
80105738:	e8 bc 04 00 00       	call   80105bf9 <release>
    acquire(lk);
8010573d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105740:	89 04 24             	mov    %eax,(%esp)
80105743:	e8 4f 04 00 00       	call   80105b97 <acquire>
  }
}
80105748:	c9                   	leave  
80105749:	c3                   	ret    
...
80105798:	e8 fa 03 00 00       	call   80105b97 <acquire>
  wakeup1(chan);
...
801057af:	e8 45 04 00 00       	call   80105bf9 <release>
}
801057b4:	c9                   	leave  
801057b5:	c3                   	ret    
...
801057c3:	e8 cf 03 00 00       	call   80105b97 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80105802:	e8 f2 03 00 00       	call   80105bf9 <release>
      return 0;
...
80105825:	e8 cf 03 00 00       	call   80105bf9 <release>
  return -1;
...
8010587d:	eb 07                	jmp    80105886 <procdump+0x55>
      ...
      state = "???";
8010587f:	c7 45 ec 44 96 10 80 	movl   $0x80109644,-0x14(%ebp)
...
801058a1:	c7 04 24 48 96 10 80 	movl   $0x80109648,(%esp)
...
801058ce:	e8 75 03 00 00       	call   80105c48 <getcallerpcs>
...
801058e7:	c7 04 24 51 96 10 80 	movl   $0x80109651,(%esp)
...
80105906:	75 d4                	jne    801058dc <procdump+0xab>
    ...
    cprintf("\n");
80105908:	c7 04 24 55 96 10 80 	movl   $0x80109655,(%esp)
...
80105991:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80105994:	c7 04 24 a0 41 11 80 	movl   $0x801141a0,(%esp)
8010599b:	e8 f7 01 00 00       	call   80105b97 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
801059a0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801059a7:	c7 45 f4 d4 41 11 80 	movl   $0x801141d4,-0xc(%ebp)
801059ae:	e9 f8 00 00 00       	jmp    80105aab <wait2+0x11d>
      if(p->parent != proc)
801059b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059b6:	8b 50 14             	mov    0x14(%eax),%edx
801059b9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059bf:	39 c2                	cmp    %eax,%edx
801059c1:	0f 85 dc 00 00 00    	jne    80105aa3 <wait2+0x115>
        continue;
      havekids = 1;
801059c7:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
801059ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059d1:	8b 40 0c             	mov    0xc(%eax),%eax
801059d4:	83 f8 05             	cmp    $0x5,%eax
801059d7:	0f 85 c7 00 00 00    	jne    80105aa4 <wait2+0x116>
        // Found one.
        *retime=p->retime;
801059dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e0:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
801059e6:	89 c2                	mov    %eax,%edx
801059e8:	8b 45 08             	mov    0x8(%ebp),%eax
801059eb:	89 10                	mov    %edx,(%eax)
        *rutime=p->rutime;
801059ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059f0:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801059f6:	89 c2                	mov    %eax,%edx
801059f8:	8b 45 0c             	mov    0xc(%ebp),%eax
801059fb:	89 10                	mov    %edx,(%eax)
        *stime=p->stime;
801059fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a00:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80105a06:	89 c2                	mov    %eax,%edx
80105a08:	8b 45 10             	mov    0x10(%ebp),%eax
80105a0b:	89 10                	mov    %edx,(%eax)
        p->retime=0;
80105a0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a10:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
80105a17:	00 00 00 
        p->rutime=0;
80105a1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a1d:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
80105a24:	00 00 00 
        p->stime=0;
80105a27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a2a:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80105a31:	00 00 00 
        pid = p->pid;
80105a34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a37:	8b 40 10             	mov    0x10(%eax),%eax
80105a3a:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
80105a3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a40:	8b 40 08             	mov    0x8(%eax),%eax
80105a43:	89 04 24             	mov    %eax,(%esp)
80105a46:	e8 e3 d8 ff ff       	call   8010332e <kfree>
        p->kstack = 0;
80105a4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a4e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
80105a55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a58:	8b 40 04             	mov    0x4(%eax),%eax
80105a5b:	89 04 24             	mov    %eax,(%esp)
80105a5e:	e8 06 35 00 00       	call   80108f69 <freevm>
        p->state = UNUSED;
80105a63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a66:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80105a6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a70:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80105a77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a7a:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80105a81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a84:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80105a88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a8b:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80105a92:	c7 04 24 a0 41 11 80 	movl   $0x801141a0,(%esp)
80105a99:	e8 5b 01 00 00       	call   80105bf9 <release>
        return pid;
80105a9e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105aa1:	eb 56                	jmp    80105af9 <wait2+0x16b>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80105aa3:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105aa4:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80105aab:	81 7d f4 d4 65 11 80 	cmpl   $0x801165d4,-0xc(%ebp)
80105ab2:	0f 82 fb fe ff ff    	jb     801059b3 <wait2+0x25>
        return pid;
      }
    }
...
80105abc:	74 0d                	je     80105acb <wait2+0x13d>
80105abe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ac4:	8b 40 24             	mov    0x24(%eax),%eax
80105ac7:	85 c0                	test   %eax,%eax
80105ac9:	74 13                	je     80105ade <wait2+0x150>
      release(&ptable.lock);
80105acb:	c7 04 24 a0 41 11 80 	movl   $0x801141a0,(%esp)
80105ad2:	e8 22 01 00 00       	call   80105bf9 <release>
      return -1;
80105ad7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105adc:	eb 1b                	jmp    80105af9 <wait2+0x16b>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80105ade:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ae4:	c7 44 24 04 a0 41 11 	movl   $0x801141a0,0x4(%esp)
80105aeb:	80 
80105aec:	89 04 24             	mov    %eax,(%esp)
80105aef:	e8 bb fb ff ff       	call   801056af <sleep>
  }
80105af4:	e9 a7 fe ff ff       	jmp    801059a0 <wait2+0x12>
}
80105af9:	c9                   	leave  
80105afa:	c3                   	ret    
...
80105afe:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
80105b02:	0f 9f c2             	setg   %dl
80105b05:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80105b09:	0f 9e c0             	setle  %al
80105b0c:	09 d0                	or     %edx,%eax
80105b0e:	84 c0                	test   %al,%al
80105b10:	74 07                	je     80105b19 <set_prio+0x1e>
    return -1;
80105b12:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b17:	eb 14                	jmp    80105b2d <set_prio+0x32>
  proc->priority=priority;
80105b19:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b1f:	8b 55 08             	mov    0x8(%ebp),%edx
80105b22:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
  return 0;
...
80105b37:	9c                   	pushf  
80105b38:	5b                   	pop    %ebx
80105b39:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
80105b55:	83 ec 10             	sub    $0x10,%esp
  ...
  asm volatile("lock; xchgl %0, %1" :
               "+m" (*addr), "=a" (result) :
80105b58:	8b 55 08             	mov    0x8(%ebp),%edx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80105b5b:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80105b5e:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80105b65:	f0 87 02             	lock xchg %eax,(%edx)
80105b68:	89 c3                	mov    %eax,%ebx
80105b6a:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80105b6d:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80105b7c:	8b 55 0c             	mov    0xc(%ebp),%edx
80105b7f:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105b82:	8b 45 08             	mov    0x8(%ebp),%eax
80105b85:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80105b8b:	8b 45 08             	mov    0x8(%ebp),%eax
80105b8e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80105b95:	5d                   	pop    %ebp
80105b96:	c3                   	ret    
...
80105b9d:	e8 3d 01 00 00       	call   80105cdf <pushcli>
  if(holding(lk))
80105ba2:	8b 45 08             	mov    0x8(%ebp),%eax
80105ba5:	89 04 24             	mov    %eax,(%esp)
80105ba8:	e8 08 01 00 00       	call   80105cb5 <holding>
80105bad:	85 c0                	test   %eax,%eax
80105baf:	74 0c                	je     80105bbd <acquire+0x26>
    panic("acquire");
80105bb1:	c7 04 24 81 96 10 80 	movl   $0x80109681,(%esp)
80105bb8:	e8 80 a9 ff ff       	call   8010053d <panic>
...
80105bc1:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105bc8:	00 
80105bc9:	89 04 24             	mov    %eax,(%esp)
80105bcc:	e8 80 ff ff ff       	call   80105b51 <xchg>
80105bd1:	85 c0                	test   %eax,%eax
80105bd3:	75 e9                	jne    80105bbe <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80105bd5:	8b 45 08             	mov    0x8(%ebp),%eax
80105bd8:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105bdf:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105be2:	8b 45 08             	mov    0x8(%ebp),%eax
80105be5:	83 c0 0c             	add    $0xc,%eax
80105be8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bec:	8d 45 08             	lea    0x8(%ebp),%eax
80105bef:	89 04 24             	mov    %eax,(%esp)
80105bf2:	e8 51 00 00 00       	call   80105c48 <getcallerpcs>
}
80105bf7:	c9                   	leave  
80105bf8:	c3                   	ret    
...
80105c05:	e8 ab 00 00 00       	call   80105cb5 <holding>
80105c0a:	85 c0                	test   %eax,%eax
80105c0c:	75 0c                	jne    80105c1a <release+0x21>
    panic("release");
80105c0e:	c7 04 24 89 96 10 80 	movl   $0x80109689,(%esp)
80105c15:	e8 23 a9 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
80105c1a:	8b 45 08             	mov    0x8(%ebp),%eax
80105c1d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105c24:	8b 45 08             	mov    0x8(%ebp),%eax
80105c27:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105c3c:	e8 10 ff ff ff       	call   80105b51 <xchg>

  popcli();
80105c41:	e8 e1 00 00 00       	call   80105d27 <popcli>
}
80105c46:	c9                   	leave  
80105c47:	c3                   	ret    

80105c48 <getcallerpcs>:
...
80105c51:	83 e8 08             	sub    $0x8,%eax
80105c54:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105c57:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105c5e:	eb 32                	jmp    80105c92 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105c60:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105c64:	74 47                	je     80105cad <getcallerpcs+0x65>
80105c66:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105c6d:	76 3e                	jbe    80105cad <getcallerpcs+0x65>
80105c6f:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105c73:	74 38                	je     80105cad <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105c75:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105c78:	c1 e0 02             	shl    $0x2,%eax
80105c7b:	03 45 0c             	add    0xc(%ebp),%eax
80105c7e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c81:	8b 52 04             	mov    0x4(%edx),%edx
80105c84:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80105c86:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105c89:	8b 00                	mov    (%eax),%eax
80105c8b:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80105c8e:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105c92:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105c96:	7e c8                	jle    80105c60 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105c98:	eb 13                	jmp    80105cad <getcallerpcs+0x65>
    pcs[i] = 0;
80105c9a:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105c9d:	c1 e0 02             	shl    $0x2,%eax
80105ca0:	03 45 0c             	add    0xc(%ebp),%eax
80105ca3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  for(; i < 10; i++)
80105ca9:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105cad:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105cb1:	7e e7                	jle    80105c9a <getcallerpcs+0x52>
    pcs[i] = 0;
}
80105cb3:	c9                   	leave  
80105cb4:	c3                   	ret    
...
80105cbf:	74 17                	je     80105cd8 <holding+0x23>
80105cc1:	8b 45 08             	mov    0x8(%ebp),%eax
80105cc4:	8b 50 08             	mov    0x8(%eax),%edx
80105cc7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105ccd:	39 c2                	cmp    %eax,%edx
80105ccf:	75 07                	jne    80105cd8 <holding+0x23>
80105cd1:	b8 01 00 00 00       	mov    $0x1,%eax
80105cd6:	eb 05                	jmp    80105cdd <holding+0x28>
...
80105ce2:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80105ce5:	e8 46 fe ff ff       	call   80105b30 <readeflags>
80105cea:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105ced:	e8 53 fe ff ff       	call   80105b45 <cli>
  if(cpu->ncli++ == 0)
80105cf2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105cf8:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105cfe:	85 d2                	test   %edx,%edx
80105d00:	0f 94 c1             	sete   %cl
80105d03:	83 c2 01             	add    $0x1,%edx
80105d06:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105d0c:	84 c9                	test   %cl,%cl
80105d0e:	74 15                	je     80105d25 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105d10:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105d16:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105d19:	81 e2 00 02 00 00    	and    $0x200,%edx
80105d1f:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105d25:	c9                   	leave  
80105d26:	c3                   	ret    
...
80105d2a:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105d2d:	e8 fe fd ff ff       	call   80105b30 <readeflags>
80105d32:	25 00 02 00 00       	and    $0x200,%eax
80105d37:	85 c0                	test   %eax,%eax
80105d39:	74 0c                	je     80105d47 <popcli+0x20>
    panic("popcli - interruptible");
80105d3b:	c7 04 24 91 96 10 80 	movl   $0x80109691,(%esp)
80105d42:	e8 f6 a7 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
...
80105d64:	79 0c                	jns    80105d72 <popcli+0x4b>
    panic("popcli");
80105d66:	c7 04 24 a8 96 10 80 	movl   $0x801096a8,(%esp)
80105d6d:	e8 cb a7 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105d72:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105d78:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105d7e:	85 c0                	test   %eax,%eax
80105d80:	75 15                	jne    80105d97 <popcli+0x70>
80105d82:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105d88:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105d8e:	85 c0                	test   %eax,%eax
80105d90:	74 05                	je     80105d97 <popcli+0x70>
    sti();
80105d92:	e8 b4 fd ff ff       	call   80105b4b <sti>
}
80105d97:	c9                   	leave  
80105d98:	c3                   	ret    
80105d99:	00 00                	add    %al,(%eax)
	...
...
80105da1:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105da4:	8b 55 10             	mov    0x10(%ebp),%edx
80105da7:	8b 45 0c             	mov    0xc(%ebp),%eax
80105daa:	89 cb                	mov    %ecx,%ebx
80105dac:	89 df                	mov    %ebx,%edi
80105dae:	89 d1                	mov    %edx,%ecx
80105db0:	fc                   	cld    
80105db1:	f3 aa                	rep stos %al,%es:(%edi)
80105db3:	89 ca                	mov    %ecx,%edx
80105db5:	89 fb                	mov    %edi,%ebx
80105db7:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105dba:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105def:	83 e0 03             	and    $0x3,%eax
80105df2:	85 c0                	test   %eax,%eax
80105df4:	75 49                	jne    80105e3f <memset+0x59>
80105df6:	8b 45 10             	mov    0x10(%ebp),%eax
80105df9:	83 e0 03             	and    $0x3,%eax
80105dfc:	85 c0                	test   %eax,%eax
80105dfe:	75 3f                	jne    80105e3f <memset+0x59>
    c &= 0xFF;
80105e00:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105e07:	8b 45 10             	mov    0x10(%ebp),%eax
80105e0a:	c1 e8 02             	shr    $0x2,%eax
80105e0d:	89 c2                	mov    %eax,%edx
80105e0f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e12:	89 c1                	mov    %eax,%ecx
80105e14:	c1 e1 18             	shl    $0x18,%ecx
80105e17:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e1a:	c1 e0 10             	shl    $0x10,%eax
80105e1d:	09 c1                	or     %eax,%ecx
80105e1f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e22:	c1 e0 08             	shl    $0x8,%eax
80105e25:	09 c8                	or     %ecx,%eax
80105e27:	0b 45 0c             	or     0xc(%ebp),%eax
80105e2a:	89 54 24 08          	mov    %edx,0x8(%esp)
80105e2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e32:	8b 45 08             	mov    0x8(%ebp),%eax
80105e35:	89 04 24             	mov    %eax,(%esp)
80105e38:	e8 84 ff ff ff       	call   80105dc1 <stosl>
80105e3d:	eb 19                	jmp    80105e58 <memset+0x72>
  } else
    stosb(dst, c, n);
80105e3f:	8b 45 10             	mov    0x10(%ebp),%eax
80105e42:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e46:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e49:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e4d:	8b 45 08             	mov    0x8(%ebp),%eax
80105e50:	89 04 24             	mov    %eax,(%esp)
80105e53:	e8 44 ff ff ff       	call   80105d9c <stosb>
  return dst;
...
80105e60:	83 ec 10             	sub    $0x10,%esp
  const uchar *s1, *s2;
  
  s1 = v1;
80105e63:	8b 45 08             	mov    0x8(%ebp),%eax
80105e66:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
80105e69:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e6c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105e6f:	eb 32                	jmp    80105ea3 <memcmp+0x46>
    if(*s1 != *s2)
80105e71:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105e74:	0f b6 10             	movzbl (%eax),%edx
80105e77:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105e7a:	0f b6 00             	movzbl (%eax),%eax
80105e7d:	38 c2                	cmp    %al,%dl
80105e7f:	74 1a                	je     80105e9b <memcmp+0x3e>
      return *s1 - *s2;
80105e81:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105e84:	0f b6 00             	movzbl (%eax),%eax
80105e87:	0f b6 d0             	movzbl %al,%edx
80105e8a:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105e8d:	0f b6 00             	movzbl (%eax),%eax
80105e90:	0f b6 c0             	movzbl %al,%eax
80105e93:	89 d1                	mov    %edx,%ecx
80105e95:	29 c1                	sub    %eax,%ecx
80105e97:	89 c8                	mov    %ecx,%eax
80105e99:	eb 1c                	jmp    80105eb7 <memcmp+0x5a>
    s1++, s2++;
80105e9b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105e9f:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
80105ea3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105ea7:	0f 95 c0             	setne  %al
80105eaa:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105eae:	84 c0                	test   %al,%al
80105eb0:	75 bf                	jne    80105e71 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105ed6:	8b 55 fc             	mov    -0x4(%ebp),%edx
...
80105f05:	0f 95 c0             	setne  %al
80105f08:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105f0c:	84 c0                	test   %al,%al
80105f0e:	75 de                	jne    80105eee <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105f10:	eb 25                	jmp    80105f37 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105f1b:	88 10                	mov    %dl,(%eax)
80105f1d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105f21:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105f25:	eb 01                	jmp    80105f28 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105f27:	90                   	nop
80105f28:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105f2c:	0f 95 c0             	setne  %al
80105f2f:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105f33:	84 c0                	test   %al,%al
80105f35:	75 db                	jne    80105f12 <memmove+0x59>
      *d++ = *s++;

  return dst;
80105f37:	8b 45 08             	mov    0x8(%ebp),%eax
}
80105f3a:	c9                   	leave  
80105f3b:	c3                   	ret    
...
80105f42:	8b 45 10             	mov    0x10(%ebp),%eax
80105f45:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f49:	8b 45 0c             	mov    0xc(%ebp),%eax
80105f4c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f50:	8b 45 08             	mov    0x8(%ebp),%eax
80105f53:	89 04 24             	mov    %eax,(%esp)
80105f56:	e8 5e ff ff ff       	call   80105eb9 <memmove>
}
80105f5b:	c9                   	leave  
80105f5c:	c3                   	ret    
...
80105f5e:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105f60:	eb 0c                	jmp    80105f6e <strncmp+0x11>
    n--, p++, q++;
80105f62:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105f66:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105f6a:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80105f6e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105f72:	74 1a                	je     80105f8e <strncmp+0x31>
80105f74:	8b 45 08             	mov    0x8(%ebp),%eax
80105f77:	0f b6 00             	movzbl (%eax),%eax
80105f7a:	84 c0                	test   %al,%al
80105f7c:	74 10                	je     80105f8e <strncmp+0x31>
80105f7e:	8b 45 08             	mov    0x8(%ebp),%eax
80105f81:	0f b6 10             	movzbl (%eax),%edx
80105f84:	8b 45 0c             	mov    0xc(%ebp),%eax
80105f87:	0f b6 00             	movzbl (%eax),%eax
80105f8a:	38 c2                	cmp    %al,%dl
80105f8c:	74 d4                	je     80105f62 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105f8e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105f92:	75 07                	jne    80105f9b <strncmp+0x3e>
    return 0;
80105f94:	b8 00 00 00 00       	mov    $0x0,%eax
80105f99:	eb 18                	jmp    80105fb3 <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80105f9b:	8b 45 08             	mov    0x8(%ebp),%eax
80105f9e:	0f b6 00             	movzbl (%eax),%eax
80105fa1:	0f b6 d0             	movzbl %al,%edx
80105fa4:	8b 45 0c             	mov    0xc(%ebp),%eax
80105fa7:	0f b6 00             	movzbl (%eax),%eax
80105faa:	0f b6 c0             	movzbl %al,%eax
80105fad:	89 d1                	mov    %edx,%ecx
80105faf:	29 c1                	sub    %eax,%ecx
80105fb1:	89 c8                	mov    %ecx,%eax
}
80105fb3:	5d                   	pop    %ebp
80105fb4:	c3                   	ret    
...
80105fc6:	0f 9f c0             	setg   %al
80105fc9:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105fcd:	84 c0                	test   %al,%al
80105fcf:	74 30                	je     80106001 <strncpy+0x4c>
80105fd1:	8b 45 0c             	mov    0xc(%ebp),%eax
80105fd4:	0f b6 10             	movzbl (%eax),%edx
...
80105fe4:	0f 95 c0             	setne  %al
80105fe7:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105feb:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105fef:	84 c0                	test   %al,%al
80105ff1:	75 cf                	jne    80105fc2 <strncpy+0xd>
    ;
  while(n-- > 0)
80105ff3:	eb 0c                	jmp    80106001 <strncpy+0x4c>
    *s++ = 0;
80105ff5:	8b 45 08             	mov    0x8(%ebp),%eax
80105ff8:	c6 00 00             	movb   $0x0,(%eax)
80105ffb:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105fff:	eb 01                	jmp    80106002 <strncpy+0x4d>
  char *os;
...
80106006:	0f 9f c0             	setg   %al
80106009:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010600d:	84 c0                	test   %al,%al
8010600f:	75 e4                	jne    80105ff5 <strncpy+0x40>
    *s++ = 0;
  return os;
...
8010601f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80106022:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106026:	7f 05                	jg     8010602d <safestrcpy+0x17>
    return os;
80106028:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010602b:	eb 35                	jmp    80106062 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
8010602d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80106031:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106035:	7e 22                	jle    80106059 <safestrcpy+0x43>
80106037:	8b 45 0c             	mov    0xc(%ebp),%eax
8010603a:	0f b6 10             	movzbl (%eax),%edx
8010603d:	8b 45 08             	mov    0x8(%ebp),%eax
80106040:	88 10                	mov    %dl,(%eax)
80106042:	8b 45 08             	mov    0x8(%ebp),%eax
80106045:	0f b6 00             	movzbl (%eax),%eax
80106048:	84 c0                	test   %al,%al
8010604a:	0f 95 c0             	setne  %al
8010604d:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80106051:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80106055:	84 c0                	test   %al,%al
80106057:	75 d4                	jne    8010602d <safestrcpy+0x17>
    ;
  *s = 0;
...
8010607a:	03 45 08             	add    0x8(%ebp),%eax
8010607d:	0f b6 00             	movzbl (%eax),%eax
80106080:	84 c0                	test   %al,%al
80106082:	75 ef                	jne    80106073 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010608c:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80106090:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80106097:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80106098:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010609a:	89 d4                	mov    %edx,%esp
...
801060ad:	8b 00                	mov    (%eax),%eax
801060af:	3b 45 08             	cmp    0x8(%ebp),%eax
801060b2:	76 12                	jbe    801060c6 <fetchint+0x22>
801060b4:	8b 45 08             	mov    0x8(%ebp),%eax
801060b7:	8d 50 04             	lea    0x4(%eax),%edx
801060ba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801060c0:	8b 00                	mov    (%eax),%eax
801060c2:	39 c2                	cmp    %eax,%edx
801060c4:	76 07                	jbe    801060cd <fetchint+0x29>
    return -1;
801060c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060cb:	eb 0f                	jmp    801060dc <fetchint+0x38>
  *ip = *(int*)(addr);
801060cd:	8b 45 08             	mov    0x8(%ebp),%eax
801060d0:	8b 10                	mov    (%eax),%edx
801060d2:	8b 45 0c             	mov    0xc(%ebp),%eax
801060d5:	89 10                	mov    %edx,(%eax)
  return 0;
...
801060e1:	83 ec 10             	sub    $0x10,%esp
  char *s, *ep;
...
801060ef:	77 07                	ja     801060f8 <fetchstr+0x1a>
    return -1;
801060f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f6:	eb 48                	jmp    80106140 <fetchstr+0x62>
  *pp = (char*)addr;
801060f8:	8b 55 08             	mov    0x8(%ebp),%edx
801060fb:	8b 45 0c             	mov    0xc(%ebp),%eax
801060fe:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
80106100:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106106:	8b 00                	mov    (%eax),%eax
80106108:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
8010610b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010610e:	8b 00                	mov    (%eax),%eax
80106110:	89 45 fc             	mov    %eax,-0x4(%ebp)
80106113:	eb 1e                	jmp    80106133 <fetchstr+0x55>
    if(*s == 0)
80106115:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106118:	0f b6 00             	movzbl (%eax),%eax
8010611b:	84 c0                	test   %al,%al
8010611d:	75 10                	jne    8010612f <fetchstr+0x51>
      return s - *pp;
8010611f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80106122:	8b 45 0c             	mov    0xc(%ebp),%eax
80106125:	8b 00                	mov    (%eax),%eax
80106127:	89 d1                	mov    %edx,%ecx
80106129:	29 c1                	sub    %eax,%ecx
8010612b:	89 c8                	mov    %ecx,%eax
8010612d:	eb 11                	jmp    80106140 <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
8010612f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80106133:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106136:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80106139:	72 da                	jb     80106115 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010614e:	8b 40 18             	mov    0x18(%eax),%eax
80106151:	8b 50 44             	mov    0x44(%eax),%edx
80106154:	8b 45 08             	mov    0x8(%ebp),%eax
80106157:	c1 e0 02             	shl    $0x2,%eax
8010615a:	01 d0                	add    %edx,%eax
8010615c:	8d 50 04             	lea    0x4(%eax),%edx
8010615f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106162:	89 44 24 04          	mov    %eax,0x4(%esp)
80106166:	89 14 24             	mov    %edx,(%esp)
80106169:	e8 36 ff ff ff       	call   801060a4 <fetchint>
}
8010616e:	c9                   	leave  
8010616f:	c3                   	ret    
...
80106173:	83 ec 18             	sub    $0x18,%esp
  ...
  if(argint(n, &i) < 0)
80106176:	8d 45 fc             	lea    -0x4(%ebp),%eax
80106179:	89 44 24 04          	mov    %eax,0x4(%esp)
8010617d:	8b 45 08             	mov    0x8(%ebp),%eax
80106180:	89 04 24             	mov    %eax,(%esp)
80106183:	e8 ba ff ff ff       	call   80106142 <argint>
80106188:	85 c0                	test   %eax,%eax
8010618a:	79 07                	jns    80106193 <argptr+0x23>
    return -1;
8010618c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106191:	eb 3d                	jmp    801061d0 <argptr+0x60>
...
801061a2:	73 16                	jae    801061ba <argptr+0x4a>
801061a4:	8b 45 fc             	mov    -0x4(%ebp),%eax
801061a7:	89 c2                	mov    %eax,%edx
801061a9:	8b 45 10             	mov    0x10(%ebp),%eax
801061ac:	01 c2                	add    %eax,%edx
801061ae:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801061b4:	8b 00                	mov    (%eax),%eax
801061b6:	39 c2                	cmp    %eax,%edx
801061b8:	76 07                	jbe    801061c1 <argptr+0x51>
    return -1;
801061ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061bf:	eb 0f                	jmp    801061d0 <argptr+0x60>
  *pp = (char*)i;
801061c1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801061c4:	89 c2                	mov    %eax,%edx
801061c6:	8b 45 0c             	mov    0xc(%ebp),%eax
801061c9:	89 10                	mov    %edx,(%eax)
  return 0;
...
801061d5:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
801061d8:	8d 45 fc             	lea    -0x4(%ebp),%eax
801061db:	89 44 24 04          	mov    %eax,0x4(%esp)
801061df:	8b 45 08             	mov    0x8(%ebp),%eax
801061e2:	89 04 24             	mov    %eax,(%esp)
801061e5:	e8 58 ff ff ff       	call   80106142 <argint>
801061ea:	85 c0                	test   %eax,%eax
801061ec:	79 07                	jns    801061f5 <argstr+0x23>
    return -1;
801061ee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061f3:	eb 12                	jmp    80106207 <argstr+0x35>
  return fetchstr(addr, pp);
801061f5:	8b 45 fc             	mov    -0x4(%ebp),%eax
801061f8:	8b 55 0c             	mov    0xc(%ebp),%edx
801061fb:	89 54 24 04          	mov    %edx,0x4(%esp)
801061ff:	89 04 24             	mov    %eax,(%esp)
80106202:	e8 d7 fe ff ff       	call   801060de <fetchstr>
}
80106207:	c9                   	leave  
80106208:	c3                   	ret    
...
80106219:	8b 40 1c             	mov    0x1c(%eax),%eax
8010621c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010621f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106223:	7e 30                	jle    80106255 <syscall+0x4c>
80106225:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106228:	83 f8 18             	cmp    $0x18,%eax
8010622b:	77 28                	ja     80106255 <syscall+0x4c>
8010622d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106230:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80106237:	85 c0                	test   %eax,%eax
80106239:	74 1a                	je     80106255 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
8010623b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106241:	8b 58 18             	mov    0x18(%eax),%ebx
80106244:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106247:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
8010624e:	ff d0                	call   *%eax
80106250:	89 43 1c             	mov    %eax,0x1c(%ebx)
80106253:	eb 3d                	jmp    80106292 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80106255:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010625b:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010625e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80106264:	8b 40 10             	mov    0x10(%eax),%eax
80106267:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010626a:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010626e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106272:	89 44 24 04          	mov    %eax,0x4(%esp)
80106276:	c7 04 24 af 96 10 80 	movl   $0x801096af,(%esp)
8010627d:	e8 1f a1 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80106282:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106288:	8b 40 18             	mov    0x18(%eax),%eax
8010628b:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80106292:	83 c4 24             	add    $0x24,%esp
80106295:	5b                   	pop    %ebx
80106296:	5d                   	pop    %ebp
80106297:	c3                   	ret    
...
801062ab:	e8 92 fe ff ff       	call   80106142 <argint>
801062b0:	85 c0                	test   %eax,%eax
801062b2:	79 07                	jns    801062bb <argfd+0x23>
    return -1;
801062b4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062b9:	eb 50                	jmp    8010630b <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801062bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062be:	85 c0                	test   %eax,%eax
801062c0:	78 21                	js     801062e3 <argfd+0x4b>
801062c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c5:	83 f8 0f             	cmp    $0xf,%eax
801062c8:	7f 19                	jg     801062e3 <argfd+0x4b>
801062ca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801062d0:	8b 55 f0             	mov    -0x10(%ebp),%edx
801062d3:	83 c2 08             	add    $0x8,%edx
801062d6:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801062da:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062dd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062e1:	75 07                	jne    801062ea <argfd+0x52>
    return -1;
801062e3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e8:	eb 21                	jmp    8010630b <argfd+0x73>
  if(pfd)
801062ea:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801062ee:	74 08                	je     801062f8 <argfd+0x60>
    *pfd = fd;
801062f0:	8b 55 f0             	mov    -0x10(%ebp),%edx
801062f3:	8b 45 0c             	mov    0xc(%ebp),%eax
801062f6:	89 10                	mov    %edx,(%eax)
  if(pf)
801062f8:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801062fc:	74 08                	je     80106306 <argfd+0x6e>
    *pf = f;
801062fe:	8b 45 10             	mov    0x10(%ebp),%eax
80106301:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106304:	89 10                	mov    %edx,(%eax)
  return 0;
80106306:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010630b:	c9                   	leave  
8010630c:	c3                   	ret    
...
8010631a:	eb 30                	jmp    8010634c <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
8010631c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106322:	8b 55 fc             	mov    -0x4(%ebp),%edx
80106325:	83 c2 08             	add    $0x8,%edx
80106328:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010632c:	85 c0                	test   %eax,%eax
8010632e:	75 18                	jne    80106348 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80106330:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106336:	8b 55 fc             	mov    -0x4(%ebp),%edx
80106339:	8d 4a 08             	lea    0x8(%edx),%ecx
8010633c:	8b 55 08             	mov    0x8(%ebp),%edx
8010633f:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80106343:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106346:	eb 0f                	jmp    80106357 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80106348:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010634c:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80106350:	7e ca                	jle    8010631c <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
8010635c:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
8010635f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106362:	89 44 24 08          	mov    %eax,0x8(%esp)
80106366:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010636d:	00 
8010636e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106375:	e8 1e ff ff ff       	call   80106298 <argfd>
8010637a:	85 c0                	test   %eax,%eax
8010637c:	79 07                	jns    80106385 <sys_dup+0x2c>
    return -1;
8010637e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106383:	eb 29                	jmp    801063ae <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80106385:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106388:	89 04 24             	mov    %eax,(%esp)
8010638b:	e8 7d ff ff ff       	call   8010630d <fdalloc>
80106390:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106393:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106397:	79 07                	jns    801063a0 <sys_dup+0x47>
    return -1;
80106399:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010639e:	eb 0e                	jmp    801063ae <sys_dup+0x55>
  filedup(f);
801063a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063a3:	89 04 24             	mov    %eax,(%esp)
801063a6:	e8 fd b3 ff ff       	call   801017a8 <filedup>
  return fd;
...
801063cc:	e8 c7 fe ff ff       	call   80106298 <argfd>
801063d1:	85 c0                	test   %eax,%eax
801063d3:	78 35                	js     8010640a <sys_read+0x5a>
801063d5:	8d 45 f0             	lea    -0x10(%ebp),%eax
801063d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801063dc:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801063e3:	e8 5a fd ff ff       	call   80106142 <argint>
801063e8:	85 c0                	test   %eax,%eax
801063ea:	78 1e                	js     8010640a <sys_read+0x5a>
801063ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063ef:	89 44 24 08          	mov    %eax,0x8(%esp)
801063f3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801063f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801063fa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106401:	e8 6a fd ff ff       	call   80106170 <argptr>
80106406:	85 c0                	test   %eax,%eax
80106408:	79 07                	jns    80106411 <sys_read+0x61>
    return -1;
8010640a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010640f:	eb 19                	jmp    8010642a <sys_read+0x7a>
  return fileread(f, p, n);
80106411:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80106414:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
80106425:	e8 eb b4 ff ff       	call   80101915 <fileread>
}
8010642a:	c9                   	leave  
8010642b:	c3                   	ret    
...
80106439:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106440:	00 
80106441:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106448:	e8 4b fe ff ff       	call   80106298 <argfd>
8010644d:	85 c0                	test   %eax,%eax
8010644f:	78 35                	js     80106486 <sys_write+0x5a>
80106451:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106454:	89 44 24 04          	mov    %eax,0x4(%esp)
80106458:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010645f:	e8 de fc ff ff       	call   80106142 <argint>
80106464:	85 c0                	test   %eax,%eax
80106466:	78 1e                	js     80106486 <sys_write+0x5a>
80106468:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010646b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010646f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106472:	89 44 24 04          	mov    %eax,0x4(%esp)
80106476:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010647d:	e8 ee fc ff ff       	call   80106170 <argptr>
80106482:	85 c0                	test   %eax,%eax
80106484:	79 07                	jns    8010648d <sys_write+0x61>
    return -1;
80106486:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010648b:	eb 19                	jmp    801064a6 <sys_write+0x7a>
  return filewrite(f, p, n);
8010648d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80106490:	8b 55 ec             	mov    -0x14(%ebp),%edx
80106493:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106496:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010649a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010649e:	89 04 24             	mov    %eax,(%esp)
801064a1:	e8 2b b5 ff ff       	call   801019d1 <filewrite>
}
801064a6:	c9                   	leave  
801064a7:	c3                   	ret    
...
801064ab:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
801064ae:	8d 45 f0             	lea    -0x10(%ebp),%eax
801064b1:	89 44 24 08          	mov    %eax,0x8(%esp)
801064b5:	8d 45 f4             	lea    -0xc(%ebp),%eax
801064b8:	89 44 24 04          	mov    %eax,0x4(%esp)
801064bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801064c3:	e8 d0 fd ff ff       	call   80106298 <argfd>
801064c8:	85 c0                	test   %eax,%eax
801064ca:	79 07                	jns    801064d3 <sys_close+0x2b>
    return -1;
801064cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064d1:	eb 24                	jmp    801064f7 <sys_close+0x4f>
  proc->ofile[fd] = 0;
801064d3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064d9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801064dc:	83 c2 08             	add    $0x8,%edx
801064df:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801064e6:	00 
  fileclose(f);
801064e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ea:	89 04 24             	mov    %eax,(%esp)
801064ed:	e8 fe b2 ff ff       	call   801017f0 <fileclose>
  return 0;
...
80106502:	89 44 24 08          	mov    %eax,0x8(%esp)
80106506:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010650d:	00 
8010650e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106515:	e8 7e fd ff ff       	call   80106298 <argfd>
8010651a:	85 c0                	test   %eax,%eax
8010651c:	78 1f                	js     8010653d <sys_fstat+0x44>
8010651e:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80106525:	00 
80106526:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106529:	89 44 24 04          	mov    %eax,0x4(%esp)
8010652d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106534:	e8 37 fc ff ff       	call   80106170 <argptr>
80106539:	85 c0                	test   %eax,%eax
8010653b:	79 07                	jns    80106544 <sys_fstat+0x4b>
    return -1;
8010653d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106542:	eb 12                	jmp    80106556 <sys_fstat+0x5d>
  return filestat(f, st);
80106544:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106547:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010654a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010654e:	89 04 24             	mov    %eax,(%esp)
80106551:	e8 70 b3 ff ff       	call   801018c6 <filestat>
}
80106556:	c9                   	leave  
80106557:	c3                   	ret    
...
8010655b:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010655e:	8d 45 d8             	lea    -0x28(%ebp),%eax
80106561:	89 44 24 04          	mov    %eax,0x4(%esp)
80106565:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010656c:	e8 61 fc ff ff       	call   801061d2 <argstr>
80106571:	85 c0                	test   %eax,%eax
80106573:	78 17                	js     8010658c <sys_link+0x34>
80106575:	8d 45 dc             	lea    -0x24(%ebp),%eax
80106578:	89 44 24 04          	mov    %eax,0x4(%esp)
8010657c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106583:	e8 4a fc ff ff       	call   801061d2 <argstr>
80106588:	85 c0                	test   %eax,%eax
8010658a:	79 0a                	jns    80106596 <sys_link+0x3e>
    return -1;
8010658c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106591:	e9 41 01 00 00       	jmp    801066d7 <sys_link+0x17f>

  begin_op();
80106596:	e8 76 d7 ff ff       	call   80103d11 <begin_op>
  if((ip = namei(old)) == 0){
8010659b:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010659e:	89 04 24             	mov    %eax,(%esp)
801065a1:	e8 f7 c6 ff ff       	call   80102c9d <namei>
801065a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801065ad:	75 0f                	jne    801065be <sys_link+0x66>
    end_op();
801065af:	e8 de d7 ff ff       	call   80103d92 <end_op>
    return -1;
801065b4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065b9:	e9 19 01 00 00       	jmp    801066d7 <sys_link+0x17f>
  }

  ilock(ip);
801065be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c1:	89 04 24             	mov    %eax,(%esp)
801065c4:	e8 2c bb ff ff       	call   801020f5 <ilock>
  if(ip->type == T_DIR){
801065c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065cc:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801065d0:	66 83 f8 01          	cmp    $0x1,%ax
801065d4:	75 1a                	jne    801065f0 <sys_link+0x98>
    iunlockput(ip);
801065d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065d9:	89 04 24             	mov    %eax,(%esp)
801065dc:	e8 9e bd ff ff       	call   8010237f <iunlockput>
    end_op();
801065e1:	e8 ac d7 ff ff       	call   80103d92 <end_op>
    return -1;
801065e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065eb:	e9 e7 00 00 00       	jmp    801066d7 <sys_link+0x17f>
  }

  ip->nlink++;
801065f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065f3:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801065f7:	8d 50 01             	lea    0x1(%eax),%edx
801065fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065fd:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106601:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106604:	89 04 24             	mov    %eax,(%esp)
80106607:	e8 27 b9 ff ff       	call   80101f33 <iupdate>
  iunlock(ip);
8010660c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010660f:	89 04 24             	mov    %eax,(%esp)
80106612:	e8 32 bc ff ff       	call   80102249 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80106617:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010661a:	8d 55 e2             	lea    -0x1e(%ebp),%edx
8010661d:	89 54 24 04          	mov    %edx,0x4(%esp)
80106621:	89 04 24             	mov    %eax,(%esp)
80106624:	e8 96 c6 ff ff       	call   80102cbf <nameiparent>
80106629:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010662c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106630:	74 68                	je     8010669a <sys_link+0x142>
    goto bad;
  ilock(dp);
80106632:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106635:	89 04 24             	mov    %eax,(%esp)
80106638:	e8 b8 ba ff ff       	call   801020f5 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010663d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106640:	8b 10                	mov    (%eax),%edx
80106642:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106645:	8b 00                	mov    (%eax),%eax
80106647:	39 c2                	cmp    %eax,%edx
80106649:	75 20                	jne    8010666b <sys_link+0x113>
8010664b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010664e:	8b 40 04             	mov    0x4(%eax),%eax
80106651:	89 44 24 08          	mov    %eax,0x8(%esp)
80106655:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80106658:	89 44 24 04          	mov    %eax,0x4(%esp)
8010665c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010665f:	89 04 24             	mov    %eax,(%esp)
80106662:	e8 75 c3 ff ff       	call   801029dc <dirlink>
80106667:	85 c0                	test   %eax,%eax
80106669:	79 0d                	jns    80106678 <sys_link+0x120>
    iunlockput(dp);
8010666b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010666e:	89 04 24             	mov    %eax,(%esp)
80106671:	e8 09 bd ff ff       	call   8010237f <iunlockput>
    goto bad;
80106676:	eb 23                	jmp    8010669b <sys_link+0x143>
  }
  iunlockput(dp);
80106678:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010667b:	89 04 24             	mov    %eax,(%esp)
8010667e:	e8 fc bc ff ff       	call   8010237f <iunlockput>
  iput(ip);
80106683:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106686:	89 04 24             	mov    %eax,(%esp)
80106689:	e8 20 bc ff ff       	call   801022ae <iput>

  end_op();
8010668e:	e8 ff d6 ff ff       	call   80103d92 <end_op>

  return 0;
80106693:	b8 00 00 00 00       	mov    $0x0,%eax
80106698:	eb 3d                	jmp    801066d7 <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
801066a1:	e8 4f ba ff ff       	call   801020f5 <ilock>
  ip->nlink--;
801066a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a9:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801066ad:	8d 50 ff             	lea    -0x1(%eax),%edx
801066b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b3:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801066b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ba:	89 04 24             	mov    %eax,(%esp)
801066bd:	e8 71 b8 ff ff       	call   80101f33 <iupdate>
  iunlockput(ip);
801066c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066c5:	89 04 24             	mov    %eax,(%esp)
801066c8:	e8 b2 bc ff ff       	call   8010237f <iunlockput>
  end_op();
801066cd:	e8 c0 d6 ff ff       	call   80103d92 <end_op>
  return -1;
...
801066df:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
801066e6:	eb 4b                	jmp    80106733 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801066e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066eb:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801066f2:	00 
...
80106704:	e8 e8 be ff ff       	call   801025f1 <readi>
80106709:	83 f8 10             	cmp    $0x10,%eax
8010670c:	74 0c                	je     8010671a <isdirempty+0x41>
      panic("isdirempty: readi");
8010670e:	c7 04 24 cb 96 10 80 	movl   $0x801096cb,(%esp)
80106715:	e8 23 9e ff ff       	call   8010053d <panic>
    if(de.inum != 0)
8010671a:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
8010671e:	66 85 c0             	test   %ax,%ax
80106721:	74 07                	je     8010672a <isdirempty+0x51>
      return 0;
80106723:	b8 00 00 00 00       	mov    $0x0,%eax
80106728:	eb 1b                	jmp    80106745 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
8010672d:	83 c0 10             	add    $0x10,%eax
80106730:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106733:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106736:	8b 45 08             	mov    0x8(%ebp),%eax
80106739:	8b 40 18             	mov    0x18(%eax),%eax
8010673c:	39 c2                	cmp    %eax,%edx
8010673e:	72 a8                	jb     801066e8 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80106740:	b8 01 00 00 00       	mov    $0x1,%eax
}
80106745:	c9                   	leave  
80106746:	c3                   	ret    
...
8010674a:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
8010674d:	8d 45 cc             	lea    -0x34(%ebp),%eax
80106750:	89 44 24 04          	mov    %eax,0x4(%esp)
80106754:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010675b:	e8 72 fa ff ff       	call   801061d2 <argstr>
80106760:	85 c0                	test   %eax,%eax
80106762:	79 0a                	jns    8010676e <sys_unlink+0x27>
    return -1;
80106764:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106769:	e9 af 01 00 00       	jmp    8010691d <sys_unlink+0x1d6>

  begin_op();
8010676e:	e8 9e d5 ff ff       	call   80103d11 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80106773:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106776:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80106779:	89 54 24 04          	mov    %edx,0x4(%esp)
8010677d:	89 04 24             	mov    %eax,(%esp)
80106780:	e8 3a c5 ff ff       	call   80102cbf <nameiparent>
80106785:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106788:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010678c:	75 0f                	jne    8010679d <sys_unlink+0x56>
    end_op();
8010678e:	e8 ff d5 ff ff       	call   80103d92 <end_op>
    return -1;
80106793:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106798:	e9 80 01 00 00       	jmp    8010691d <sys_unlink+0x1d6>
  }

  ilock(dp);
8010679d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067a0:	89 04 24             	mov    %eax,(%esp)
801067a3:	e8 4d b9 ff ff       	call   801020f5 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801067a8:	c7 44 24 04 dd 96 10 	movl   $0x801096dd,0x4(%esp)
801067af:	80 
801067b0:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801067b3:	89 04 24             	mov    %eax,(%esp)
801067b6:	e8 37 c1 ff ff       	call   801028f2 <namecmp>
801067bb:	85 c0                	test   %eax,%eax
801067bd:	0f 84 45 01 00 00    	je     80106908 <sys_unlink+0x1c1>
801067c3:	c7 44 24 04 df 96 10 	movl   $0x801096df,0x4(%esp)
801067ca:	80 
801067cb:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801067ce:	89 04 24             	mov    %eax,(%esp)
801067d1:	e8 1c c1 ff ff       	call   801028f2 <namecmp>
801067d6:	85 c0                	test   %eax,%eax
801067d8:	0f 84 2a 01 00 00    	je     80106908 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
801067de:	8d 45 c8             	lea    -0x38(%ebp),%eax
801067e1:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801067f2:	e8 1d c1 ff ff       	call   80102914 <dirlookup>
801067f7:	89 45 f0             	mov    %eax,-0x10(%ebp)
801067fa:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801067fe:	0f 84 03 01 00 00    	je     80106907 <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
80106804:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106807:	89 04 24             	mov    %eax,(%esp)
8010680a:	e8 e6 b8 ff ff       	call   801020f5 <ilock>

  if(ip->nlink < 1)
8010680f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106812:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106816:	66 85 c0             	test   %ax,%ax
80106819:	7f 0c                	jg     80106827 <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
8010681b:	c7 04 24 e2 96 10 80 	movl   $0x801096e2,(%esp)
80106822:	e8 16 9d ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106827:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010682a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010682e:	66 83 f8 01          	cmp    $0x1,%ax
80106832:	75 1f                	jne    80106853 <sys_unlink+0x10c>
80106834:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106837:	89 04 24             	mov    %eax,(%esp)
8010683a:	e8 9a fe ff ff       	call   801066d9 <isdirempty>
8010683f:	85 c0                	test   %eax,%eax
80106841:	75 10                	jne    80106853 <sys_unlink+0x10c>
    iunlockput(ip);
80106843:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106846:	89 04 24             	mov    %eax,(%esp)
80106849:	e8 31 bb ff ff       	call   8010237f <iunlockput>
    goto bad;
8010684e:	e9 b5 00 00 00       	jmp    80106908 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80106853:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010685a:	00 
8010685b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106862:	00 
80106863:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106866:	89 04 24             	mov    %eax,(%esp)
80106869:	e8 78 f5 ff ff       	call   80105de6 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010686e:	8b 45 c8             	mov    -0x38(%ebp),%eax
80106871:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106878:	00 
80106879:	89 44 24 08          	mov    %eax,0x8(%esp)
8010687d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106880:	89 44 24 04          	mov    %eax,0x4(%esp)
80106884:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106887:	89 04 24             	mov    %eax,(%esp)
8010688a:	e8 cd be ff ff       	call   8010275c <writei>
8010688f:	83 f8 10             	cmp    $0x10,%eax
80106892:	74 0c                	je     801068a0 <sys_unlink+0x159>
    panic("unlink: writei");
80106894:	c7 04 24 f4 96 10 80 	movl   $0x801096f4,(%esp)
8010689b:	e8 9d 9c ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
801068a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068a3:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801068a7:	66 83 f8 01          	cmp    $0x1,%ax
801068ab:	75 1c                	jne    801068c9 <sys_unlink+0x182>
    dp->nlink--;
801068ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068b0:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801068b4:	8d 50 ff             	lea    -0x1(%eax),%edx
801068b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068ba:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
801068be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068c1:	89 04 24             	mov    %eax,(%esp)
801068c4:	e8 6a b6 ff ff       	call   80101f33 <iupdate>
  }
  iunlockput(dp);
801068c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068cc:	89 04 24             	mov    %eax,(%esp)
801068cf:	e8 ab ba ff ff       	call   8010237f <iunlockput>

  ip->nlink--;
801068d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068d7:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801068db:	8d 50 ff             	lea    -0x1(%eax),%edx
801068de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068e1:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801068e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068e8:	89 04 24             	mov    %eax,(%esp)
801068eb:	e8 43 b6 ff ff       	call   80101f33 <iupdate>
  iunlockput(ip);
801068f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068f3:	89 04 24             	mov    %eax,(%esp)
801068f6:	e8 84 ba ff ff       	call   8010237f <iunlockput>

  end_op();
801068fb:	e8 92 d4 ff ff       	call   80103d92 <end_op>

  return 0;
80106900:	b8 00 00 00 00       	mov    $0x0,%eax
80106905:	eb 16                	jmp    8010691d <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
8010690e:	e8 6c ba ff ff       	call   8010237f <iunlockput>
  end_op();
80106913:	e8 7a d4 ff ff       	call   80103d92 <end_op>
  return -1;
...
80106922:	83 ec 48             	sub    $0x48,%esp
80106925:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106928:	8b 55 10             	mov    0x10(%ebp),%edx
8010692b:	8b 45 14             	mov    0x14(%ebp),%eax
8010692e:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106932:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106936:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010693a:	8d 45 de             	lea    -0x22(%ebp),%eax
8010693d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106941:	8b 45 08             	mov    0x8(%ebp),%eax
80106944:	89 04 24             	mov    %eax,(%esp)
80106947:	e8 73 c3 ff ff       	call   80102cbf <nameiparent>
8010694c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010694f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106953:	75 0a                	jne    8010695f <create+0x40>
    return 0;
80106955:	b8 00 00 00 00       	mov    $0x0,%eax
8010695a:	e9 7e 01 00 00       	jmp    80106add <create+0x1be>
  ilock(dp);
8010695f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106962:	89 04 24             	mov    %eax,(%esp)
80106965:	e8 8b b7 ff ff       	call   801020f5 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
8010696a:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010696d:	89 44 24 08          	mov    %eax,0x8(%esp)
80106971:	8d 45 de             	lea    -0x22(%ebp),%eax
80106974:	89 44 24 04          	mov    %eax,0x4(%esp)
80106978:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010697b:	89 04 24             	mov    %eax,(%esp)
8010697e:	e8 91 bf ff ff       	call   80102914 <dirlookup>
80106983:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106986:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010698a:	74 47                	je     801069d3 <create+0xb4>
    iunlockput(dp);
8010698c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010698f:	89 04 24             	mov    %eax,(%esp)
80106992:	e8 e8 b9 ff ff       	call   8010237f <iunlockput>
    ilock(ip);
80106997:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010699a:	89 04 24             	mov    %eax,(%esp)
8010699d:	e8 53 b7 ff ff       	call   801020f5 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801069a2:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801069a7:	75 15                	jne    801069be <create+0x9f>
801069a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069ac:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801069b0:	66 83 f8 02          	cmp    $0x2,%ax
801069b4:	75 08                	jne    801069be <create+0x9f>
      return ip;
801069b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069b9:	e9 1f 01 00 00       	jmp    80106add <create+0x1be>
    iunlockput(ip);
801069be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069c1:	89 04 24             	mov    %eax,(%esp)
801069c4:	e8 b6 b9 ff ff       	call   8010237f <iunlockput>
    return 0;
801069c9:	b8 00 00 00 00       	mov    $0x0,%eax
801069ce:	e9 0a 01 00 00       	jmp    80106add <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
801069d3:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
801069d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069da:	8b 00                	mov    (%eax),%eax
801069dc:	89 54 24 04          	mov    %edx,0x4(%esp)
801069e0:	89 04 24             	mov    %eax,(%esp)
801069e3:	e8 78 b4 ff ff       	call   80101e60 <ialloc>
801069e8:	89 45 f0             	mov    %eax,-0x10(%ebp)
801069eb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801069ef:	75 0c                	jne    801069fd <create+0xde>
    panic("create: ialloc");
801069f1:	c7 04 24 03 97 10 80 	movl   $0x80109703,(%esp)
801069f8:	e8 40 9b ff ff       	call   8010053d <panic>

  ilock(ip);
801069fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a00:	89 04 24             	mov    %eax,(%esp)
80106a03:	e8 ed b6 ff ff       	call   801020f5 <ilock>
  ip->major = major;
80106a08:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a0b:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106a0f:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106a13:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a16:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106a1a:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106a1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a21:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106a27:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a2a:	89 04 24             	mov    %eax,(%esp)
80106a2d:	e8 01 b5 ff ff       	call   80101f33 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106a32:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106a37:	75 6a                	jne    80106aa3 <create+0x184>
    dp->nlink++;  // for ".."
80106a39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a3c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106a40:	8d 50 01             	lea    0x1(%eax),%edx
80106a43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a46:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106a4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a4d:	89 04 24             	mov    %eax,(%esp)
80106a50:	e8 de b4 ff ff       	call   80101f33 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106a55:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a58:	8b 40 04             	mov    0x4(%eax),%eax
80106a5b:	89 44 24 08          	mov    %eax,0x8(%esp)
80106a5f:	c7 44 24 04 dd 96 10 	movl   $0x801096dd,0x4(%esp)
80106a66:	80 
80106a67:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a6a:	89 04 24             	mov    %eax,(%esp)
80106a6d:	e8 6a bf ff ff       	call   801029dc <dirlink>
80106a72:	85 c0                	test   %eax,%eax
80106a74:	78 21                	js     80106a97 <create+0x178>
80106a76:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a79:	8b 40 04             	mov    0x4(%eax),%eax
80106a7c:	89 44 24 08          	mov    %eax,0x8(%esp)
80106a80:	c7 44 24 04 df 96 10 	movl   $0x801096df,0x4(%esp)
80106a87:	80 
80106a88:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a8b:	89 04 24             	mov    %eax,(%esp)
80106a8e:	e8 49 bf ff ff       	call   801029dc <dirlink>
80106a93:	85 c0                	test   %eax,%eax
80106a95:	79 0c                	jns    80106aa3 <create+0x184>
      panic("create dots");
80106a97:	c7 04 24 12 97 10 80 	movl   $0x80109712,(%esp)
80106a9e:	e8 9a 9a ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80106aa3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106aa6:	8b 40 04             	mov    0x4(%eax),%eax
80106aa9:	89 44 24 08          	mov    %eax,0x8(%esp)
80106aad:	8d 45 de             	lea    -0x22(%ebp),%eax
80106ab0:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ab4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ab7:	89 04 24             	mov    %eax,(%esp)
80106aba:	e8 1d bf ff ff       	call   801029dc <dirlink>
80106abf:	85 c0                	test   %eax,%eax
80106ac1:	79 0c                	jns    80106acf <create+0x1b0>
    panic("create: dirlink");
80106ac3:	c7 04 24 1e 97 10 80 	movl   $0x8010971e,(%esp)
80106aca:	e8 6e 9a ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106acf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad2:	89 04 24             	mov    %eax,(%esp)
80106ad5:	e8 a5 b8 ff ff       	call   8010237f <iunlockput>
...
80106ae2:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106ae8:	89 44 24 04          	mov    %eax,0x4(%esp)
80106aec:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106af3:	e8 da f6 ff ff       	call   801061d2 <argstr>
80106af8:	85 c0                	test   %eax,%eax
80106afa:	78 17                	js     80106b13 <sys_open+0x34>
80106afc:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106aff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106b0a:	e8 33 f6 ff ff       	call   80106142 <argint>
80106b0f:	85 c0                	test   %eax,%eax
80106b11:	79 0a                	jns    80106b1d <sys_open+0x3e>
    return -1;
80106b13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b18:	e9 5a 01 00 00       	jmp    80106c77 <sys_open+0x198>

  begin_op();
80106b1d:	e8 ef d1 ff ff       	call   80103d11 <begin_op>

  if(omode & O_CREATE){
80106b22:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b25:	25 00 02 00 00       	and    $0x200,%eax
80106b2a:	85 c0                	test   %eax,%eax
80106b2c:	74 3b                	je     80106b69 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80106b2e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106b31:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106b38:	00 
80106b39:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106b40:	00 
80106b41:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106b48:	00 
80106b49:	89 04 24             	mov    %eax,(%esp)
80106b4c:	e8 ce fd ff ff       	call   8010691f <create>
80106b51:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80106b54:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106b58:	75 6b                	jne    80106bc5 <sys_open+0xe6>
      end_op();
80106b5a:	e8 33 d2 ff ff       	call   80103d92 <end_op>
      return -1;
80106b5f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b64:	e9 0e 01 00 00       	jmp    80106c77 <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
80106b69:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106b6c:	89 04 24             	mov    %eax,(%esp)
80106b6f:	e8 29 c1 ff ff       	call   80102c9d <namei>
80106b74:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106b77:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106b7b:	75 0f                	jne    80106b8c <sys_open+0xad>
      end_op();
80106b7d:	e8 10 d2 ff ff       	call   80103d92 <end_op>
      return -1;
80106b82:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b87:	e9 eb 00 00 00       	jmp    80106c77 <sys_open+0x198>
    }
    ilock(ip);
80106b8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b8f:	89 04 24             	mov    %eax,(%esp)
80106b92:	e8 5e b5 ff ff       	call   801020f5 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106b97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b9a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106b9e:	66 83 f8 01          	cmp    $0x1,%ax
80106ba2:	75 21                	jne    80106bc5 <sys_open+0xe6>
80106ba4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ba7:	85 c0                	test   %eax,%eax
80106ba9:	74 1a                	je     80106bc5 <sys_open+0xe6>
      iunlockput(ip);
80106bab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bae:	89 04 24             	mov    %eax,(%esp)
80106bb1:	e8 c9 b7 ff ff       	call   8010237f <iunlockput>
      end_op();
80106bb6:	e8 d7 d1 ff ff       	call   80103d92 <end_op>
      return -1;
80106bbb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bc0:	e9 b2 00 00 00       	jmp    80106c77 <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106bc5:	e8 7e ab ff ff       	call   80101748 <filealloc>
80106bca:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106bcd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106bd1:	74 14                	je     80106be7 <sys_open+0x108>
80106bd3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106bd6:	89 04 24             	mov    %eax,(%esp)
80106bd9:	e8 2f f7 ff ff       	call   8010630d <fdalloc>
80106bde:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106be1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106be5:	79 28                	jns    80106c0f <sys_open+0x130>
    if(f)
80106be7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106beb:	74 0b                	je     80106bf8 <sys_open+0x119>
      fileclose(f);
80106bed:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106bf0:	89 04 24             	mov    %eax,(%esp)
80106bf3:	e8 f8 ab ff ff       	call   801017f0 <fileclose>
    iunlockput(ip);
80106bf8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bfb:	89 04 24             	mov    %eax,(%esp)
80106bfe:	e8 7c b7 ff ff       	call   8010237f <iunlockput>
    end_op();
80106c03:	e8 8a d1 ff ff       	call   80103d92 <end_op>
    return -1;
80106c08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c0d:	eb 68                	jmp    80106c77 <sys_open+0x198>
  }
  iunlock(ip);
80106c0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c12:	89 04 24             	mov    %eax,(%esp)
80106c15:	e8 2f b6 ff ff       	call   80102249 <iunlock>
  end_op();
80106c1a:	e8 73 d1 ff ff       	call   80103d92 <end_op>

  f->type = FD_INODE;
80106c1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c22:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106c28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c2b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106c2e:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106c31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c34:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106c3b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c3e:	83 e0 01             	and    $0x1,%eax
80106c41:	85 c0                	test   %eax,%eax
80106c43:	0f 94 c2             	sete   %dl
...
80106c52:	84 c0                	test   %al,%al
80106c54:	75 0a                	jne    80106c60 <sys_open+0x181>
80106c56:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c59:	83 e0 02             	and    $0x2,%eax
80106c5c:	85 c0                	test   %eax,%eax
80106c5e:	74 07                	je     80106c67 <sys_open+0x188>
80106c60:	b8 01 00 00 00       	mov    $0x1,%eax
80106c65:	eb 05                	jmp    80106c6c <sys_open+0x18d>
...
80106c7c:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
80106c7f:	e8 8d d0 ff ff       	call   80103d11 <begin_op>
...
80106c92:	e8 3b f5 ff ff       	call   801061d2 <argstr>
80106c97:	85 c0                	test   %eax,%eax
80106c99:	78 2c                	js     80106cc7 <sys_mkdir+0x4e>
80106c9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c9e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106ca5:	00 
80106ca6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106cad:	00 
80106cae:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106cb5:	00 
80106cb6:	89 04 24             	mov    %eax,(%esp)
80106cb9:	e8 61 fc ff ff       	call   8010691f <create>
80106cbe:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106cc1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106cc5:	75 0c                	jne    80106cd3 <sys_mkdir+0x5a>
    end_op();
80106cc7:	e8 c6 d0 ff ff       	call   80103d92 <end_op>
    return -1;
80106ccc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cd1:	eb 15                	jmp    80106ce8 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106cd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cd6:	89 04 24             	mov    %eax,(%esp)
80106cd9:	e8 a1 b6 ff ff       	call   8010237f <iunlockput>
  end_op();
80106cde:	e8 af d0 ff ff       	call   80103d92 <end_op>
  return 0;
...
80106ced:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80106cf0:	e8 1c d0 ff ff       	call   80103d11 <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106cf5:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106cf8:	89 44 24 04          	mov    %eax,0x4(%esp)
80106cfc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d03:	e8 ca f4 ff ff       	call   801061d2 <argstr>
80106d08:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106d0b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106d0f:	78 5e                	js     80106d6f <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106d11:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106d14:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106d1f:	e8 1e f4 ff ff       	call   80106142 <argint>
  char *path;
  int len;
  int major, minor;
...
80106d26:	78 47                	js     80106d6f <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106d28:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106d2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d2f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106d36:	e8 07 f4 ff ff       	call   80106142 <argint>
  int len;
  int major, minor;
...
80106d3d:	78 30                	js     80106d6f <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106d3f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d42:	0f bf c8             	movswl %ax,%ecx
80106d45:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106d48:	0f bf d0             	movswl %ax,%edx
80106d4b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106d4e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106d52:	89 54 24 08          	mov    %edx,0x8(%esp)
80106d56:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106d5d:	00 
80106d5e:	89 04 24             	mov    %eax,(%esp)
80106d61:	e8 b9 fb ff ff       	call   8010691f <create>
80106d66:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106d69:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106d6d:	75 0c                	jne    80106d7b <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80106d6f:	e8 1e d0 ff ff       	call   80103d92 <end_op>
    return -1;
80106d74:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d79:	eb 15                	jmp    80106d90 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106d7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d7e:	89 04 24             	mov    %eax,(%esp)
80106d81:	e8 f9 b5 ff ff       	call   8010237f <iunlockput>
  end_op();
80106d86:	e8 07 d0 ff ff       	call   80103d92 <end_op>
  return 0;
...
80106d95:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106d98:	e8 74 cf ff ff       	call   80103d11 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106d9d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106da0:	89 44 24 04          	mov    %eax,0x4(%esp)
80106da4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106dab:	e8 22 f4 ff ff       	call   801061d2 <argstr>
80106db0:	85 c0                	test   %eax,%eax
80106db2:	78 14                	js     80106dc8 <sys_chdir+0x36>
80106db4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106db7:	89 04 24             	mov    %eax,(%esp)
80106dba:	e8 de be ff ff       	call   80102c9d <namei>
80106dbf:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106dc2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106dc6:	75 0c                	jne    80106dd4 <sys_chdir+0x42>
    end_op();
80106dc8:	e8 c5 cf ff ff       	call   80103d92 <end_op>
    return -1;
80106dcd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106dd2:	eb 61                	jmp    80106e35 <sys_chdir+0xa3>
  }
  ilock(ip);
80106dd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dd7:	89 04 24             	mov    %eax,(%esp)
80106dda:	e8 16 b3 ff ff       	call   801020f5 <ilock>
  if(ip->type != T_DIR){
80106ddf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106de2:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106de6:	66 83 f8 01          	cmp    $0x1,%ax
80106dea:	74 17                	je     80106e03 <sys_chdir+0x71>
    iunlockput(ip);
80106dec:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106def:	89 04 24             	mov    %eax,(%esp)
80106df2:	e8 88 b5 ff ff       	call   8010237f <iunlockput>
    end_op();
80106df7:	e8 96 cf ff ff       	call   80103d92 <end_op>
    return -1;
80106dfc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e01:	eb 32                	jmp    80106e35 <sys_chdir+0xa3>
  }
  iunlock(ip);
80106e03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e06:	89 04 24             	mov    %eax,(%esp)
80106e09:	e8 3b b4 ff ff       	call   80102249 <iunlock>
  iput(proc->cwd);
80106e0e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e14:	8b 40 68             	mov    0x68(%eax),%eax
80106e17:	89 04 24             	mov    %eax,(%esp)
80106e1a:	e8 8f b4 ff ff       	call   801022ae <iput>
  end_op();
80106e1f:	e8 6e cf ff ff       	call   80103d92 <end_op>
  proc->cwd = ip;
80106e24:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e2a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106e2d:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106e3a:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80106e40:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106e43:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e47:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e4e:	e8 7f f3 ff ff       	call   801061d2 <argstr>
80106e53:	85 c0                	test   %eax,%eax
80106e55:	78 1a                	js     80106e71 <sys_exec+0x3a>
80106e57:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106e5d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106e68:	e8 d5 f2 ff ff       	call   80106142 <argint>
80106e6d:	85 c0                	test   %eax,%eax
80106e6f:	79 0a                	jns    80106e7b <sys_exec+0x44>
    return -1;
80106e71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e76:	e9 cc 00 00 00       	jmp    80106f47 <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
80106e7b:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106e82:	00 
80106e83:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106e8a:	00 
80106e8b:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106e91:	89 04 24             	mov    %eax,(%esp)
80106e94:	e8 4d ef ff ff       	call   80105de6 <memset>
  for(i=0;; i++){
80106e99:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106ea0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ea3:	83 f8 1f             	cmp    $0x1f,%eax
80106ea6:	76 0a                	jbe    80106eb2 <sys_exec+0x7b>
      return -1;
80106ea8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ead:	e9 95 00 00 00       	jmp    80106f47 <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106eb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eb5:	c1 e0 02             	shl    $0x2,%eax
80106eb8:	89 c2                	mov    %eax,%edx
80106eba:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106ec0:	01 c2                	add    %eax,%edx
80106ec2:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106ec8:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ecc:	89 14 24             	mov    %edx,(%esp)
80106ecf:	e8 d0 f1 ff ff       	call   801060a4 <fetchint>
80106ed4:	85 c0                	test   %eax,%eax
80106ed6:	79 07                	jns    80106edf <sys_exec+0xa8>
      return -1;
80106ed8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106edd:	eb 68                	jmp    80106f47 <sys_exec+0x110>
    if(uarg == 0){
80106edf:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106ee5:	85 c0                	test   %eax,%eax
80106ee7:	75 26                	jne    80106f0f <sys_exec+0xd8>
      argv[i] = 0;
80106ee9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eec:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106ef3:	00 00 00 00 
      break;
80106ef7:	90                   	nop
    }
...
80106ef8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106efb:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106f01:	89 54 24 04          	mov    %edx,0x4(%esp)
80106f05:	89 04 24             	mov    %eax,(%esp)
80106f08:	e8 0f a4 ff ff       	call   8010131c <exec>
80106f0d:	eb 38                	jmp    80106f47 <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106f12:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106f19:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106f1f:	01 c2                	add    %eax,%edx
80106f21:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106f27:	89 54 24 04          	mov    %edx,0x4(%esp)
80106f2b:	89 04 24             	mov    %eax,(%esp)
80106f2e:	e8 ab f1 ff ff       	call   801060de <fetchstr>
80106f33:	85 c0                	test   %eax,%eax
80106f35:	79 07                	jns    80106f3e <sys_exec+0x107>
      return -1;
80106f37:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f3c:	eb 09                	jmp    80106f47 <sys_exec+0x110>
...
80106f42:	e9 59 ff ff ff       	jmp    80106ea0 <sys_exec+0x69>
  return exec(path, argv);
}
80106f47:	c9                   	leave  
80106f48:	c3                   	ret    
...
80106f4c:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106f4f:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106f56:	00 
80106f57:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106f5a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f5e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106f65:	e8 06 f2 ff ff       	call   80106170 <argptr>
80106f6a:	85 c0                	test   %eax,%eax
80106f6c:	79 0a                	jns    80106f78 <sys_pipe+0x2f>
    return -1;
80106f6e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f73:	e9 9b 00 00 00       	jmp    80107013 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106f78:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106f7b:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f7f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106f82:	89 04 24             	mov    %eax,(%esp)
80106f85:	e8 b2 d8 ff ff       	call   8010483c <pipealloc>
80106f8a:	85 c0                	test   %eax,%eax
80106f8c:	79 07                	jns    80106f95 <sys_pipe+0x4c>
    return -1;
80106f8e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f93:	eb 7e                	jmp    80107013 <sys_pipe+0xca>
  fd0 = -1;
80106f95:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106f9c:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106f9f:	89 04 24             	mov    %eax,(%esp)
80106fa2:	e8 66 f3 ff ff       	call   8010630d <fdalloc>
80106fa7:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106faa:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106fae:	78 14                	js     80106fc4 <sys_pipe+0x7b>
80106fb0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106fb3:	89 04 24             	mov    %eax,(%esp)
80106fb6:	e8 52 f3 ff ff       	call   8010630d <fdalloc>
80106fbb:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106fbe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106fc2:	79 37                	jns    80106ffb <sys_pipe+0xb2>
    if(fd0 >= 0)
80106fc4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106fc8:	78 14                	js     80106fde <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106fca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106fd0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106fd3:	83 c2 08             	add    $0x8,%edx
80106fd6:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106fdd:	00 
    fileclose(rf);
80106fde:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106fe1:	89 04 24             	mov    %eax,(%esp)
80106fe4:	e8 07 a8 ff ff       	call   801017f0 <fileclose>
    fileclose(wf);
80106fe9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106fec:	89 04 24             	mov    %eax,(%esp)
80106fef:	e8 fc a7 ff ff       	call   801017f0 <fileclose>
    return -1;
80106ff4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ff9:	eb 18                	jmp    80107013 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106ffb:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106ffe:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107001:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80107003:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107006:	8d 50 04             	lea    0x4(%eax),%edx
80107009:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010700c:	89 02                	mov    %eax,(%edx)
  return 0;
8010700e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107013:	c9                   	leave  
80107014:	c3                   	ret    
80107015:	00 00                	add    %al,(%eax)
	...
...
8010701b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010701e:	e8 dc de ff ff       	call   80104eff <fork>
}
80107023:	c9                   	leave  
80107024:	c3                   	ret    
...
80107028:	83 ec 08             	sub    $0x8,%esp
  exit();
8010702b:	e8 86 e0 ff ff       	call   801050b6 <exit>
  return 0;  // not reached
80107030:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107035:	c9                   	leave  
80107036:	c3                   	ret    
...
8010703a:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010703d:	e8 99 e1 ff ff       	call   801051db <wait>
}
80107042:	c9                   	leave  
80107043:	c3                   	ret    
...
80107058:	e8 e5 f0 ff ff       	call   80106142 <argint>
8010705d:	85 c0                	test   %eax,%eax
8010705f:	79 07                	jns    80107068 <sys_kill+0x24>
    return -1;
80107061:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107066:	eb 0b                	jmp    80107073 <sys_kill+0x2f>
  return kill(pid);
80107068:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010706b:	89 04 24             	mov    %eax,(%esp)
8010706e:	e8 43 e7 ff ff       	call   801057b6 <kill>
}
80107073:	c9                   	leave  
80107074:	c3                   	ret    
...
80107086:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80107089:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010708c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107090:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107097:	e8 a6 f0 ff ff       	call   80106142 <argint>
8010709c:	85 c0                	test   %eax,%eax
8010709e:	79 07                	jns    801070a7 <sys_sbrk+0x24>
    return -1;
801070a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070a5:	eb 24                	jmp    801070cb <sys_sbrk+0x48>
  addr = proc->sz;
801070a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070ad:	8b 00                	mov    (%eax),%eax
801070af:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
801070b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801070b5:	89 04 24             	mov    %eax,(%esp)
801070b8:	e8 9d dd ff ff       	call   80104e5a <growproc>
801070bd:	85 c0                	test   %eax,%eax
801070bf:	79 07                	jns    801070c8 <sys_sbrk+0x45>
    return -1;
801070c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070c6:	eb 03                	jmp    801070cb <sys_sbrk+0x48>
  return addr;
...
801070d0:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;

  if(argint(0, &n) < 0)
801070d3:	8d 45 f0             	lea    -0x10(%ebp),%eax
801070d6:	89 44 24 04          	mov    %eax,0x4(%esp)
801070da:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801070e1:	e8 5c f0 ff ff       	call   80106142 <argint>
801070e6:	85 c0                	test   %eax,%eax
801070e8:	79 07                	jns    801070f1 <sys_sleep+0x24>
    return -1;
801070ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070ef:	eb 6c                	jmp    8010715d <sys_sleep+0x90>
  acquire(&tickslock);
801070f1:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
801070f8:	e8 9a ea ff ff       	call   80105b97 <acquire>
  ticks0 = ticks;
801070fd:	a1 20 6e 11 80       	mov    0x80116e20,%eax
80107102:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80107105:	eb 34                	jmp    8010713b <sys_sleep+0x6e>
    if(proc->killed){
80107107:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010710d:	8b 40 24             	mov    0x24(%eax),%eax
80107110:	85 c0                	test   %eax,%eax
80107112:	74 13                	je     80107127 <sys_sleep+0x5a>
      release(&tickslock);
80107114:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
8010711b:	e8 d9 ea ff ff       	call   80105bf9 <release>
      return -1;
80107120:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107125:	eb 36                	jmp    8010715d <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80107127:	c7 44 24 04 e0 65 11 	movl   $0x801165e0,0x4(%esp)
8010712e:	80 
8010712f:	c7 04 24 20 6e 11 80 	movl   $0x80116e20,(%esp)
80107136:	e8 74 e5 ff ff       	call   801056af <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010713b:	a1 20 6e 11 80       	mov    0x80116e20,%eax
80107140:	89 c2                	mov    %eax,%edx
80107142:	2b 55 f4             	sub    -0xc(%ebp),%edx
80107145:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107148:	39 c2                	cmp    %eax,%edx
8010714a:	72 bb                	jb     80107107 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010714c:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
80107153:	e8 a1 ea ff ff       	call   80105bf9 <release>
  return 0;
80107158:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010715d:	c9                   	leave  
8010715e:	c3                   	ret    
...
80107162:	83 ec 28             	sub    $0x28,%esp
  uint xticks;

  acquire(&tickslock);
80107165:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
8010716c:	e8 26 ea ff ff       	call   80105b97 <acquire>
  xticks = ticks;
80107171:	a1 20 6e 11 80       	mov    0x80116e20,%eax
80107176:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80107179:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
80107180:	e8 74 ea ff ff       	call   80105bf9 <release>
  return xticks;
...
sys_wait2(void)
{
8010718a:	55                   	push   %ebp
8010718b:	89 e5                	mov    %esp,%ebp
8010718d:	83 ec 28             	sub    $0x28,%esp
  int retime;
  int rutime;
  int stime;
  if(argint(0,&retime) < 0)
80107190:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107193:	89 44 24 04          	mov    %eax,0x4(%esp)
80107197:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010719e:	e8 9f ef ff ff       	call   80106142 <argint>
801071a3:	85 c0                	test   %eax,%eax
801071a5:	79 07                	jns    801071ae <sys_wait2+0x24>
    return -1;
801071a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801071ac:	eb 59                	jmp    80107207 <sys_wait2+0x7d>
  if(argint(1,&rutime) < 0)
801071ae:	8d 45 f0             	lea    -0x10(%ebp),%eax
801071b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801071b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801071bc:	e8 81 ef ff ff       	call   80106142 <argint>
801071c1:	85 c0                	test   %eax,%eax
801071c3:	79 07                	jns    801071cc <sys_wait2+0x42>
    return -1;
801071c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801071ca:	eb 3b                	jmp    80107207 <sys_wait2+0x7d>
  if(argint(2,&stime) < 0)
801071cc:	8d 45 ec             	lea    -0x14(%ebp),%eax
801071cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801071d3:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801071da:	e8 63 ef ff ff       	call   80106142 <argint>
801071df:	85 c0                	test   %eax,%eax
801071e1:	79 07                	jns    801071ea <sys_wait2+0x60>
    return -1;
801071e3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801071e8:	eb 1d                	jmp    80107207 <sys_wait2+0x7d>
  return wait2((int*)retime, (int*)rutime, (int*)stime);
801071ea:	8b 45 ec             	mov    -0x14(%ebp),%eax
801071ed:	89 c1                	mov    %eax,%ecx
801071ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801071f2:	89 c2                	mov    %eax,%edx
801071f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071f7:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801071fb:	89 54 24 04          	mov    %edx,0x4(%esp)
801071ff:	89 04 24             	mov    %eax,(%esp)
80107202:	e8 87 e7 ff ff       	call   8010598e <wait2>
}
80107207:	c9                   	leave  
80107208:	c3                   	ret    

80107209 <sys_set_prio>:


int
sys_set_prio(void)
{
80107209:	55                   	push   %ebp
8010720a:	89 e5                	mov    %esp,%ebp
8010720c:	83 ec 28             	sub    $0x28,%esp
  int priority;
  if (argint(0,&priority) <0)
8010720f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107212:	89 44 24 04          	mov    %eax,0x4(%esp)
80107216:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010721d:	e8 20 ef ff ff       	call   80106142 <argint>
80107222:	85 c0                	test   %eax,%eax
80107224:	79 07                	jns    8010722d <sys_set_prio+0x24>
    return -1;
80107226:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010722b:	eb 0b                	jmp    80107238 <sys_set_prio+0x2f>
  return set_prio(priority);
8010722d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107230:	89 04 24             	mov    %eax,(%esp)
80107233:	e8 c3 e8 ff ff       	call   80105afb <set_prio>
}
80107238:	c9                   	leave  
80107239:	c3                   	ret    
...
8010723d:	83 ec 08             	sub    $0x8,%esp
  yield();
80107240:	e8 f9 e3 ff ff       	call   8010563e <yield>
  return 0;
...
80107252:	8b 55 08             	mov    0x8(%ebp),%edx
80107255:	8b 45 0c             	mov    0xc(%ebp),%eax
80107258:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010725c:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010725f:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107263:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80107267:	ee                   	out    %al,(%dx)
}
80107268:	c9                   	leave  
80107269:	c3                   	ret    
...
80107270:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80107277:	00 
80107278:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010727f:	e8 c8 ff ff ff       	call   8010724c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80107284:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010728b:	00 
8010728c:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80107293:	e8 b4 ff ff ff       	call   8010724c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80107298:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
8010729f:	00 
801072a0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801072a7:	e8 a0 ff ff ff       	call   8010724c <outb>
  picenable(IRQ_TIMER);
801072ac:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801072b3:	e8 0d d4 ff ff       	call   801046c5 <picenable>
}
801072b8:	c9                   	leave  
801072b9:	c3                   	ret    
	...
...
801072bd:	06                   	push   %es
  pushl %fs
801072be:	0f a0                	push   %fs
  pushl %gs
801072c0:	0f a8                	push   %gs
  pushal
801072c2:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801072c3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801072c7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801072c9:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801072cb:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801072cf:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801072d1:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801072d3:	54                   	push   %esp
  call trap
801072d4:	e8 de 01 00 00       	call   801074b7 <trap>
  addl $4, %esp
801072d9:	83 c4 04             	add    $0x4,%esp
...
801072dc:	61                   	popa   
  popl %gs
801072dd:	0f a9                	pop    %gs
  popl %fs
801072df:	0f a1                	pop    %fs
  popl %es
801072e1:	07                   	pop    %es
  popl %ds
801072e2:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801072e3:	83 c4 08             	add    $0x8,%esp
  iret
801072e6:	cf                   	iret   
	...
...
{
801072e8:	55                   	push   %ebp
801072e9:	89 e5                	mov    %esp,%ebp
801072eb:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801072ee:	8b 45 0c             	mov    0xc(%ebp),%eax
801072f1:	83 e8 01             	sub    $0x1,%eax
801072f4:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801072f8:	8b 45 08             	mov    0x8(%ebp),%eax
801072fb:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801072ff:	8b 45 08             	mov    0x8(%ebp),%eax
80107302:	c1 e8 10             	shr    $0x10,%eax
80107305:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80107309:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010730c:	0f 01 18             	lidtl  (%eax)
}
8010730f:	c9                   	leave  
80107310:	c3                   	ret    
...
80107315:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80107318:	0f 20 d3             	mov    %cr2,%ebx
8010731b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
8010731e:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
8010732a:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
8010732d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107334:	e9 c3 00 00 00       	jmp    801073fc <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80107339:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010733c:	8b 04 85 a4 c0 10 80 	mov    -0x7fef3f5c(,%eax,4),%eax
80107343:	89 c2                	mov    %eax,%edx
80107345:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107348:	66 89 14 c5 20 66 11 	mov    %dx,-0x7fee99e0(,%eax,8)
8010734f:	80 
80107350:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107353:	66 c7 04 c5 22 66 11 	movw   $0x8,-0x7fee99de(,%eax,8)
8010735a:	80 08 00 
8010735d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107360:	0f b6 14 c5 24 66 11 	movzbl -0x7fee99dc(,%eax,8),%edx
80107367:	80 
80107368:	83 e2 e0             	and    $0xffffffe0,%edx
8010736b:	88 14 c5 24 66 11 80 	mov    %dl,-0x7fee99dc(,%eax,8)
80107372:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107375:	0f b6 14 c5 24 66 11 	movzbl -0x7fee99dc(,%eax,8),%edx
8010737c:	80 
8010737d:	83 e2 1f             	and    $0x1f,%edx
80107380:	88 14 c5 24 66 11 80 	mov    %dl,-0x7fee99dc(,%eax,8)
80107387:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010738a:	0f b6 14 c5 25 66 11 	movzbl -0x7fee99db(,%eax,8),%edx
80107391:	80 
80107392:	83 e2 f0             	and    $0xfffffff0,%edx
80107395:	83 ca 0e             	or     $0xe,%edx
80107398:	88 14 c5 25 66 11 80 	mov    %dl,-0x7fee99db(,%eax,8)
8010739f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073a2:	0f b6 14 c5 25 66 11 	movzbl -0x7fee99db(,%eax,8),%edx
801073a9:	80 
801073aa:	83 e2 ef             	and    $0xffffffef,%edx
801073ad:	88 14 c5 25 66 11 80 	mov    %dl,-0x7fee99db(,%eax,8)
801073b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073b7:	0f b6 14 c5 25 66 11 	movzbl -0x7fee99db(,%eax,8),%edx
801073be:	80 
801073bf:	83 e2 9f             	and    $0xffffff9f,%edx
801073c2:	88 14 c5 25 66 11 80 	mov    %dl,-0x7fee99db(,%eax,8)
801073c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073cc:	0f b6 14 c5 25 66 11 	movzbl -0x7fee99db(,%eax,8),%edx
801073d3:	80 
801073d4:	83 ca 80             	or     $0xffffff80,%edx
801073d7:	88 14 c5 25 66 11 80 	mov    %dl,-0x7fee99db(,%eax,8)
801073de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073e1:	8b 04 85 a4 c0 10 80 	mov    -0x7fef3f5c(,%eax,4),%eax
801073e8:	c1 e8 10             	shr    $0x10,%eax
801073eb:	89 c2                	mov    %eax,%edx
801073ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073f0:	66 89 14 c5 26 66 11 	mov    %dx,-0x7fee99da(,%eax,8)
801073f7:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801073f8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801073fc:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80107403:	0f 8e 30 ff ff ff    	jle    80107339 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107409:	a1 a4 c1 10 80       	mov    0x8010c1a4,%eax
8010740e:	66 a3 20 68 11 80    	mov    %ax,0x80116820
80107414:	66 c7 05 22 68 11 80 	movw   $0x8,0x80116822
8010741b:	08 00 
8010741d:	0f b6 05 24 68 11 80 	movzbl 0x80116824,%eax
80107424:	83 e0 e0             	and    $0xffffffe0,%eax
80107427:	a2 24 68 11 80       	mov    %al,0x80116824
8010742c:	0f b6 05 24 68 11 80 	movzbl 0x80116824,%eax
80107433:	83 e0 1f             	and    $0x1f,%eax
80107436:	a2 24 68 11 80       	mov    %al,0x80116824
8010743b:	0f b6 05 25 68 11 80 	movzbl 0x80116825,%eax
80107442:	83 c8 0f             	or     $0xf,%eax
80107445:	a2 25 68 11 80       	mov    %al,0x80116825
8010744a:	0f b6 05 25 68 11 80 	movzbl 0x80116825,%eax
80107451:	83 e0 ef             	and    $0xffffffef,%eax
80107454:	a2 25 68 11 80       	mov    %al,0x80116825
80107459:	0f b6 05 25 68 11 80 	movzbl 0x80116825,%eax
80107460:	83 c8 60             	or     $0x60,%eax
80107463:	a2 25 68 11 80       	mov    %al,0x80116825
80107468:	0f b6 05 25 68 11 80 	movzbl 0x80116825,%eax
8010746f:	83 c8 80             	or     $0xffffff80,%eax
80107472:	a2 25 68 11 80       	mov    %al,0x80116825
80107477:	a1 a4 c1 10 80       	mov    0x8010c1a4,%eax
8010747c:	c1 e8 10             	shr    $0x10,%eax
8010747f:	66 a3 26 68 11 80    	mov    %ax,0x80116826

  initlock(&tickslock, "time");
80107485:	c7 44 24 04 30 97 10 	movl   $0x80109730,0x4(%esp)
8010748c:	80 
8010748d:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
80107494:	e8 dd e6 ff ff       	call   80105b76 <initlock>
}
80107499:	c9                   	leave  
8010749a:	c3                   	ret    
...
8010749e:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801074a1:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801074a8:	00 
801074a9:	c7 04 24 20 66 11 80 	movl   $0x80116620,(%esp)
801074b0:	e8 33 fe ff ff       	call   801072e8 <lidt>
}
801074b5:	c9                   	leave  
801074b6:	c3                   	ret    
...
801074bc:	53                   	push   %ebx
801074bd:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801074c0:	8b 45 08             	mov    0x8(%ebp),%eax
801074c3:	8b 40 30             	mov    0x30(%eax),%eax
801074c6:	83 f8 40             	cmp    $0x40,%eax
801074c9:	75 3e                	jne    80107509 <trap+0x52>
    if(proc->killed)
801074cb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801074d1:	8b 40 24             	mov    0x24(%eax),%eax
801074d4:	85 c0                	test   %eax,%eax
801074d6:	74 05                	je     801074dd <trap+0x26>
      exit();
801074d8:	e8 d9 db ff ff       	call   801050b6 <exit>
    proc->tf = tf;
801074dd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801074e3:	8b 55 08             	mov    0x8(%ebp),%edx
801074e6:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801074e9:	e8 1b ed ff ff       	call   80106209 <syscall>
    if(proc->killed)
801074ee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801074f4:	8b 40 24             	mov    0x24(%eax),%eax
801074f7:	85 c0                	test   %eax,%eax
801074f9:	0f 84 5a 02 00 00    	je     80107759 <trap+0x2a2>
      exit();
801074ff:	e8 b2 db ff ff       	call   801050b6 <exit>
    return;
80107504:	e9 50 02 00 00       	jmp    80107759 <trap+0x2a2>
  }

  switch(tf->trapno){
80107509:	8b 45 08             	mov    0x8(%ebp),%eax
8010750c:	8b 40 30             	mov    0x30(%eax),%eax
8010750f:	83 e8 20             	sub    $0x20,%eax
80107512:	83 f8 1f             	cmp    $0x1f,%eax
80107515:	0f 87 c1 00 00 00    	ja     801075dc <trap+0x125>
8010751b:	8b 04 85 d8 97 10 80 	mov    -0x7fef6828(,%eax,4),%eax
80107522:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107524:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010752a:	0f b6 00             	movzbl (%eax),%eax
8010752d:	84 c0                	test   %al,%al
8010752f:	75 36                	jne    80107567 <trap+0xb0>
      acquire(&tickslock);
80107531:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
80107538:	e8 5a e6 ff ff       	call   80105b97 <acquire>
      ticks++;
8010753d:	a1 20 6e 11 80       	mov    0x80116e20,%eax
80107542:	83 c0 01             	add    $0x1,%eax
80107545:	a3 20 6e 11 80       	mov    %eax,0x80116e20
      updateTimes(); // after every tick - updates the times
8010754a:	e8 de e3 ff ff       	call   8010592d <updateTimes>
      wakeup(&ticks);
8010754f:	c7 04 24 20 6e 11 80 	movl   $0x80116e20,(%esp)
80107556:	e8 30 e2 ff ff       	call   8010578b <wakeup>
      release(&tickslock);
8010755b:	c7 04 24 e0 65 11 80 	movl   $0x801165e0,(%esp)
80107562:	e8 92 e6 ff ff       	call   80105bf9 <release>
    }
    lapiceoi();
80107567:	e8 6f c2 ff ff       	call   801037db <lapiceoi>
    break;
8010756c:	e9 41 01 00 00       	jmp    801076b2 <trap+0x1fb>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107571:	e8 46 ba ff ff       	call   80102fbc <ideintr>
    lapiceoi();
80107576:	e8 60 c2 ff ff       	call   801037db <lapiceoi>
    break;
8010757b:	e9 32 01 00 00       	jmp    801076b2 <trap+0x1fb>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80107580:	e8 0a c0 ff ff       	call   8010358f <kbdintr>
    lapiceoi();
80107585:	e8 51 c2 ff ff       	call   801037db <lapiceoi>
    break;
8010758a:	e9 23 01 00 00       	jmp    801076b2 <trap+0x1fb>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010758f:	e8 cc 03 00 00       	call   80107960 <uartintr>
    lapiceoi();
80107594:	e8 42 c2 ff ff       	call   801037db <lapiceoi>
    break;
80107599:	e9 14 01 00 00       	jmp    801076b2 <trap+0x1fb>
  case T_IRQ0 + 7:
...
8010759e:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801075a1:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801075a4:	8b 45 08             	mov    0x8(%ebp),%eax
801075a7:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801075ab:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801075ae:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801075b4:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801075b7:	0f b6 c0             	movzbl %al,%eax
801075ba:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801075be:	89 54 24 08          	mov    %edx,0x8(%esp)
801075c2:	89 44 24 04          	mov    %eax,0x4(%esp)
801075c6:	c7 04 24 38 97 10 80 	movl   $0x80109738,(%esp)
801075cd:	e8 cf 8d ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801075d2:	e8 04 c2 ff ff       	call   801037db <lapiceoi>
    break;
801075d7:	e9 d6 00 00 00       	jmp    801076b2 <trap+0x1fb>

  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
801075dc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801075e2:	85 c0                	test   %eax,%eax
801075e4:	74 11                	je     801075f7 <trap+0x140>
801075e6:	8b 45 08             	mov    0x8(%ebp),%eax
801075e9:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801075ed:	0f b7 c0             	movzwl %ax,%eax
801075f0:	83 e0 03             	and    $0x3,%eax
801075f3:	85 c0                	test   %eax,%eax
801075f5:	75 46                	jne    8010763d <trap+0x186>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801075f7:	e8 15 fd ff ff       	call   80107311 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
801075fc:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801075ff:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107602:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107609:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010760c:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010760f:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107612:	8b 52 30             	mov    0x30(%edx),%edx
80107615:	89 44 24 10          	mov    %eax,0x10(%esp)
80107619:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010761d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107621:	89 54 24 04          	mov    %edx,0x4(%esp)
80107625:	c7 04 24 5c 97 10 80 	movl   $0x8010975c,(%esp)
8010762c:	e8 70 8d ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80107631:	c7 04 24 8e 97 10 80 	movl   $0x8010978e,(%esp)
80107638:	e8 00 8f ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010763d:	e8 cf fc ff ff       	call   80107311 <rcr2>
...
80107644:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107647:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
8010764a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107650:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107653:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
80107656:	8b 45 08             	mov    0x8(%ebp),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107659:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
8010765c:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010765f:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
80107662:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107668:	83 c0 6c             	add    $0x6c,%eax
8010766b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010766e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107674:	8b 40 10             	mov    0x10(%eax),%eax
80107677:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010767b:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010767f:	89 74 24 14          	mov    %esi,0x14(%esp)
80107683:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80107687:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010768b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010768e:	89 54 24 08          	mov    %edx,0x8(%esp)
80107692:	89 44 24 04          	mov    %eax,0x4(%esp)
80107696:	c7 04 24 94 97 10 80 	movl   $0x80109794,(%esp)
8010769d:	e8 ff 8c ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
            rcr2());
    proc->killed = 1;
801076a2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801076a8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801076af:	eb 01                	jmp    801076b2 <trap+0x1fb>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801076ba:	74 24                	je     801076e0 <trap+0x229>
801076bc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801076c2:	8b 40 24             	mov    0x24(%eax),%eax
801076c5:	85 c0                	test   %eax,%eax
801076c7:	74 17                	je     801076e0 <trap+0x229>
801076c9:	8b 45 08             	mov    0x8(%ebp),%eax
801076cc:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801076d0:	0f b7 c0             	movzwl %ax,%eax
801076d3:	83 e0 03             	and    $0x3,%eax
801076d6:	83 f8 03             	cmp    $0x3,%eax
801076d9:	75 05                	jne    801076e0 <trap+0x229>
    exit();
801076db:	e8 d6 d9 ff ff       	call   801050b6 <exit>
...
801076e8:	74 3f                	je     80107729 <trap+0x272>
801076ea:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801076f0:	8b 40 0c             	mov    0xc(%eax),%eax
801076f3:	83 f8 04             	cmp    $0x4,%eax
801076f6:	75 31                	jne    80107729 <trap+0x272>
801076f8:	8b 45 08             	mov    0x8(%ebp),%eax
801076fb:	8b 40 30             	mov    0x30(%eax),%eax
801076fe:	83 f8 20             	cmp    $0x20,%eax
80107701:	75 26                	jne    80107729 <trap+0x272>
80107703:	8b 0d 20 6e 11 80    	mov    0x80116e20,%ecx
80107709:	ba cd cc cc cc       	mov    $0xcccccccd,%edx
8010770e:	89 c8                	mov    %ecx,%eax
80107710:	f7 e2                	mul    %edx
80107712:	c1 ea 02             	shr    $0x2,%edx
80107715:	89 d0                	mov    %edx,%eax
80107717:	c1 e0 02             	shl    $0x2,%eax
8010771a:	01 d0                	add    %edx,%eax
8010771c:	89 ca                	mov    %ecx,%edx
8010771e:	29 c2                	sub    %eax,%edx
80107720:	85 d2                	test   %edx,%edx
80107722:	75 05                	jne    80107729 <trap+0x272>
  #if SCHEDFLAG == DML
  proc->priority=(proc->priority==MIN_PRIORITY)? MIN_PRIORITY : proc->priority-1;
  #endif
  yield();
80107724:	e8 15 df ff ff       	call   8010563e <yield>
  }

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80107729:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010772f:	85 c0                	test   %eax,%eax
80107731:	74 27                	je     8010775a <trap+0x2a3>
80107733:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107739:	8b 40 24             	mov    0x24(%eax),%eax
8010773c:	85 c0                	test   %eax,%eax
8010773e:	74 1a                	je     8010775a <trap+0x2a3>
80107740:	8b 45 08             	mov    0x8(%ebp),%eax
80107743:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107747:	0f b7 c0             	movzwl %ax,%eax
8010774a:	83 e0 03             	and    $0x3,%eax
8010774d:	83 f8 03             	cmp    $0x3,%eax
80107750:	75 08                	jne    8010775a <trap+0x2a3>
    exit();
80107752:	e8 5f d9 ff ff       	call   801050b6 <exit>
80107757:	eb 01                	jmp    8010775a <trap+0x2a3>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
8010775a:	83 c4 3c             	add    $0x3c,%esp
8010775d:	5b                   	pop    %ebx
8010775e:	5e                   	pop    %esi
8010775f:	5f                   	pop    %edi
80107760:	5d                   	pop    %ebp
...
8010776e:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107772:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80107776:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
8010777a:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010777e:	ec                   	in     (%dx),%al
8010777f:	89 c3                	mov    %eax,%ebx
80107781:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107784:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107788:	83 c4 14             	add    $0x14,%esp
8010778b:	5b                   	pop    %ebx
8010778c:	5d                   	pop    %ebp
8010778d:	c3                   	ret    
...
80107791:	83 ec 08             	sub    $0x8,%esp
80107794:	8b 55 08             	mov    0x8(%ebp),%edx
80107797:	8b 45 0c             	mov    0xc(%ebp),%eax
8010779a:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010779e:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801077a1:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801077a5:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801077a9:	ee                   	out    %al,(%dx)
}
801077aa:	c9                   	leave  
801077ab:	c3                   	ret    
...
801077af:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
801077b9:	00 
801077ba:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801077c1:	e8 c8 ff ff ff       	call   8010778e <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801077c6:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801077cd:	00 
801077ce:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801077d5:	e8 b4 ff ff ff       	call   8010778e <outb>
  outb(COM1+0, 115200/9600);
801077da:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801077e1:	00 
801077e2:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801077e9:	e8 a0 ff ff ff       	call   8010778e <outb>
  outb(COM1+1, 0);
801077ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801077f5:	00 
801077f6:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801077fd:	e8 8c ff ff ff       	call   8010778e <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107802:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107809:	00 
8010780a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107811:	e8 78 ff ff ff       	call   8010778e <outb>
  outb(COM1+4, 0);
80107816:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010781d:	00 
8010781e:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107825:	e8 64 ff ff ff       	call   8010778e <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010782a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107831:	00 
80107832:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107839:	e8 50 ff ff ff       	call   8010778e <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010783e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107845:	e8 1a ff ff ff       	call   80107764 <inb>
8010784a:	3c ff                	cmp    $0xff,%al
8010784c:	74 6c                	je     801078ba <uartinit+0x10e>
    return;
  uart = 1;
8010784e:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80107855:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107858:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010785f:	e8 00 ff ff ff       	call   80107764 <inb>
  inb(COM1+0);
80107864:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010786b:	e8 f4 fe ff ff       	call   80107764 <inb>
  picenable(IRQ_COM1);
80107870:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107877:	e8 49 ce ff ff       	call   801046c5 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010787c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107883:	00 
80107884:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010788b:	e8 ae b9 ff ff       	call   8010323e <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107890:	c7 45 f4 58 98 10 80 	movl   $0x80109858,-0xc(%ebp)
80107897:	eb 15                	jmp    801078ae <uartinit+0x102>
    uartputc(*p);
80107899:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789c:	0f b6 00             	movzbl (%eax),%eax
8010789f:	0f be c0             	movsbl %al,%eax
801078a2:	89 04 24             	mov    %eax,(%esp)
801078a5:	e8 13 00 00 00       	call   801078bd <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801078aa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801078ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b1:	0f b6 00             	movzbl (%eax),%eax
801078b4:	84 c0                	test   %al,%al
801078b6:	75 e1                	jne    80107899 <uartinit+0xed>
801078b8:	eb 01                	jmp    801078bb <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801078c0:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
801078c3:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801078c8:	85 c0                	test   %eax,%eax
801078ca:	74 4d                	je     80107919 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801078cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801078d3:	eb 10                	jmp    801078e5 <uartputc+0x28>
    microdelay(10);
801078d5:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801078dc:	e8 1f bf ff ff       	call   80103800 <microdelay>
{
  int i;
...
80107912:	e8 77 fe ff ff       	call   8010778e <outb>
80107917:	eb 01                	jmp    8010791a <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
8010791f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107922:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107927:	85 c0                	test   %eax,%eax
80107929:	75 07                	jne    80107932 <uartgetc+0x16>
    return -1;
8010792b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107930:	eb 2c                	jmp    8010795e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107932:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107939:	e8 26 fe ff ff       	call   80107764 <inb>
8010793e:	0f b6 c0             	movzbl %al,%eax
80107941:	83 e0 01             	and    $0x1,%eax
80107944:	85 c0                	test   %eax,%eax
80107946:	75 07                	jne    8010794f <uartgetc+0x33>
    return -1;
80107948:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010794d:	eb 0f                	jmp    8010795e <uartgetc+0x42>
  return inb(COM1+0);
8010794f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107956:	e8 09 fe ff ff       	call   80107764 <inb>
8010795b:	0f b6 c0             	movzbl %al,%eax
}
8010795e:	c9                   	leave  
8010795f:	c3                   	ret    
...
80107966:	c7 04 24 1c 79 10 80 	movl   $0x8010791c,(%esp)
8010796d:	e8 3c 92 ff ff       	call   80100bae <consoleintr>
}
80107972:	c9                   	leave  
80107973:	c3                   	ret    
...
80107976:	6a 00                	push   $0x0
  jmp alltraps
80107978:	e9 3f f9 ff ff       	jmp    801072bc <alltraps>
...
8010797f:	6a 01                	push   $0x1
  jmp alltraps
80107981:	e9 36 f9 ff ff       	jmp    801072bc <alltraps>
...
80107988:	6a 02                	push   $0x2
  jmp alltraps
8010798a:	e9 2d f9 ff ff       	jmp    801072bc <alltraps>
...
80107991:	6a 03                	push   $0x3
  jmp alltraps
80107993:	e9 24 f9 ff ff       	jmp    801072bc <alltraps>
...
8010799a:	6a 04                	push   $0x4
  jmp alltraps
8010799c:	e9 1b f9 ff ff       	jmp    801072bc <alltraps>
...
801079a3:	6a 05                	push   $0x5
  jmp alltraps
801079a5:	e9 12 f9 ff ff       	jmp    801072bc <alltraps>
...
801079ac:	6a 06                	push   $0x6
  jmp alltraps
801079ae:	e9 09 f9 ff ff       	jmp    801072bc <alltraps>
...
801079b5:	6a 07                	push   $0x7
  jmp alltraps
801079b7:	e9 00 f9 ff ff       	jmp    801072bc <alltraps>
...
801079bc:	6a 08                	push   $0x8
  jmp alltraps
801079be:	e9 f9 f8 ff ff       	jmp    801072bc <alltraps>
...
801079c5:	6a 09                	push   $0x9
  jmp alltraps
801079c7:	e9 f0 f8 ff ff       	jmp    801072bc <alltraps>
...
801079cc:	6a 0a                	push   $0xa
  jmp alltraps
801079ce:	e9 e9 f8 ff ff       	jmp    801072bc <alltraps>
...
801079d3:	6a 0b                	push   $0xb
  jmp alltraps
801079d5:	e9 e2 f8 ff ff       	jmp    801072bc <alltraps>
...
801079da:	6a 0c                	push   $0xc
  jmp alltraps
801079dc:	e9 db f8 ff ff       	jmp    801072bc <alltraps>
...
801079e1:	6a 0d                	push   $0xd
  jmp alltraps
801079e3:	e9 d4 f8 ff ff       	jmp    801072bc <alltraps>
...
801079e8:	6a 0e                	push   $0xe
  jmp alltraps
801079ea:	e9 cd f8 ff ff       	jmp    801072bc <alltraps>
...
801079f1:	6a 0f                	push   $0xf
  jmp alltraps
801079f3:	e9 c4 f8 ff ff       	jmp    801072bc <alltraps>
...
801079fa:	6a 10                	push   $0x10
  jmp alltraps
801079fc:	e9 bb f8 ff ff       	jmp    801072bc <alltraps>
...
80107a01:	6a 11                	push   $0x11
  jmp alltraps
80107a03:	e9 b4 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a0a:	6a 12                	push   $0x12
  jmp alltraps
80107a0c:	e9 ab f8 ff ff       	jmp    801072bc <alltraps>
...
80107a13:	6a 13                	push   $0x13
  jmp alltraps
80107a15:	e9 a2 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a1c:	6a 14                	push   $0x14
  jmp alltraps
80107a1e:	e9 99 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a25:	6a 15                	push   $0x15
  jmp alltraps
80107a27:	e9 90 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a2e:	6a 16                	push   $0x16
  jmp alltraps
80107a30:	e9 87 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a37:	6a 17                	push   $0x17
  jmp alltraps
80107a39:	e9 7e f8 ff ff       	jmp    801072bc <alltraps>
...
80107a40:	6a 18                	push   $0x18
  jmp alltraps
80107a42:	e9 75 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a49:	6a 19                	push   $0x19
  jmp alltraps
80107a4b:	e9 6c f8 ff ff       	jmp    801072bc <alltraps>
...
80107a52:	6a 1a                	push   $0x1a
  jmp alltraps
80107a54:	e9 63 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a5b:	6a 1b                	push   $0x1b
  jmp alltraps
80107a5d:	e9 5a f8 ff ff       	jmp    801072bc <alltraps>
...
80107a64:	6a 1c                	push   $0x1c
  jmp alltraps
80107a66:	e9 51 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a6d:	6a 1d                	push   $0x1d
  jmp alltraps
80107a6f:	e9 48 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a76:	6a 1e                	push   $0x1e
  jmp alltraps
80107a78:	e9 3f f8 ff ff       	jmp    801072bc <alltraps>
...
80107a7f:	6a 1f                	push   $0x1f
  jmp alltraps
80107a81:	e9 36 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a88:	6a 20                	push   $0x20
  jmp alltraps
80107a8a:	e9 2d f8 ff ff       	jmp    801072bc <alltraps>
...
80107a91:	6a 21                	push   $0x21
  jmp alltraps
80107a93:	e9 24 f8 ff ff       	jmp    801072bc <alltraps>
...
80107a9a:	6a 22                	push   $0x22
  jmp alltraps
80107a9c:	e9 1b f8 ff ff       	jmp    801072bc <alltraps>
...
80107aa3:	6a 23                	push   $0x23
  jmp alltraps
80107aa5:	e9 12 f8 ff ff       	jmp    801072bc <alltraps>
...
80107aac:	6a 24                	push   $0x24
  jmp alltraps
80107aae:	e9 09 f8 ff ff       	jmp    801072bc <alltraps>
...
80107ab5:	6a 25                	push   $0x25
  jmp alltraps
80107ab7:	e9 00 f8 ff ff       	jmp    801072bc <alltraps>
...
80107abe:	6a 26                	push   $0x26
  jmp alltraps
80107ac0:	e9 f7 f7 ff ff       	jmp    801072bc <alltraps>
...
80107ac7:	6a 27                	push   $0x27
  jmp alltraps
80107ac9:	e9 ee f7 ff ff       	jmp    801072bc <alltraps>
...
80107ad0:	6a 28                	push   $0x28
  jmp alltraps
80107ad2:	e9 e5 f7 ff ff       	jmp    801072bc <alltraps>
...
80107ad9:	6a 29                	push   $0x29
  jmp alltraps
80107adb:	e9 dc f7 ff ff       	jmp    801072bc <alltraps>
...
80107ae2:	6a 2a                	push   $0x2a
  jmp alltraps
80107ae4:	e9 d3 f7 ff ff       	jmp    801072bc <alltraps>
...
80107aeb:	6a 2b                	push   $0x2b
  jmp alltraps
80107aed:	e9 ca f7 ff ff       	jmp    801072bc <alltraps>
...
80107af4:	6a 2c                	push   $0x2c
  jmp alltraps
80107af6:	e9 c1 f7 ff ff       	jmp    801072bc <alltraps>
...
80107afd:	6a 2d                	push   $0x2d
  jmp alltraps
80107aff:	e9 b8 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b06:	6a 2e                	push   $0x2e
  jmp alltraps
80107b08:	e9 af f7 ff ff       	jmp    801072bc <alltraps>
...
80107b0f:	6a 2f                	push   $0x2f
  jmp alltraps
80107b11:	e9 a6 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b18:	6a 30                	push   $0x30
  jmp alltraps
80107b1a:	e9 9d f7 ff ff       	jmp    801072bc <alltraps>
...
80107b21:	6a 31                	push   $0x31
  jmp alltraps
80107b23:	e9 94 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b2a:	6a 32                	push   $0x32
  jmp alltraps
80107b2c:	e9 8b f7 ff ff       	jmp    801072bc <alltraps>
...
80107b33:	6a 33                	push   $0x33
  jmp alltraps
80107b35:	e9 82 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b3c:	6a 34                	push   $0x34
  jmp alltraps
80107b3e:	e9 79 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b45:	6a 35                	push   $0x35
  jmp alltraps
80107b47:	e9 70 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b4e:	6a 36                	push   $0x36
  jmp alltraps
80107b50:	e9 67 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b57:	6a 37                	push   $0x37
  jmp alltraps
80107b59:	e9 5e f7 ff ff       	jmp    801072bc <alltraps>
...
80107b60:	6a 38                	push   $0x38
  jmp alltraps
80107b62:	e9 55 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b69:	6a 39                	push   $0x39
  jmp alltraps
80107b6b:	e9 4c f7 ff ff       	jmp    801072bc <alltraps>
...
80107b72:	6a 3a                	push   $0x3a
  jmp alltraps
80107b74:	e9 43 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b7b:	6a 3b                	push   $0x3b
  jmp alltraps
80107b7d:	e9 3a f7 ff ff       	jmp    801072bc <alltraps>
...
80107b84:	6a 3c                	push   $0x3c
  jmp alltraps
80107b86:	e9 31 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b8d:	6a 3d                	push   $0x3d
  jmp alltraps
80107b8f:	e9 28 f7 ff ff       	jmp    801072bc <alltraps>
...
80107b96:	6a 3e                	push   $0x3e
  jmp alltraps
80107b98:	e9 1f f7 ff ff       	jmp    801072bc <alltraps>
...
80107b9f:	6a 3f                	push   $0x3f
  jmp alltraps
80107ba1:	e9 16 f7 ff ff       	jmp    801072bc <alltraps>
...
80107ba8:	6a 40                	push   $0x40
  jmp alltraps
80107baa:	e9 0d f7 ff ff       	jmp    801072bc <alltraps>
...
80107bb1:	6a 41                	push   $0x41
  jmp alltraps
80107bb3:	e9 04 f7 ff ff       	jmp    801072bc <alltraps>
...
80107bba:	6a 42                	push   $0x42
  jmp alltraps
80107bbc:	e9 fb f6 ff ff       	jmp    801072bc <alltraps>
...
80107bc3:	6a 43                	push   $0x43
  jmp alltraps
80107bc5:	e9 f2 f6 ff ff       	jmp    801072bc <alltraps>
...
80107bcc:	6a 44                	push   $0x44
  jmp alltraps
80107bce:	e9 e9 f6 ff ff       	jmp    801072bc <alltraps>
...
80107bd5:	6a 45                	push   $0x45
  jmp alltraps
80107bd7:	e9 e0 f6 ff ff       	jmp    801072bc <alltraps>
...
80107bde:	6a 46                	push   $0x46
  jmp alltraps
80107be0:	e9 d7 f6 ff ff       	jmp    801072bc <alltraps>
...
80107be7:	6a 47                	push   $0x47
  jmp alltraps
80107be9:	e9 ce f6 ff ff       	jmp    801072bc <alltraps>
...
80107bf0:	6a 48                	push   $0x48
  jmp alltraps
80107bf2:	e9 c5 f6 ff ff       	jmp    801072bc <alltraps>
...
80107bf9:	6a 49                	push   $0x49
  jmp alltraps
80107bfb:	e9 bc f6 ff ff       	jmp    801072bc <alltraps>
...
80107c02:	6a 4a                	push   $0x4a
  jmp alltraps
80107c04:	e9 b3 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c0b:	6a 4b                	push   $0x4b
  jmp alltraps
80107c0d:	e9 aa f6 ff ff       	jmp    801072bc <alltraps>
...
80107c14:	6a 4c                	push   $0x4c
  jmp alltraps
80107c16:	e9 a1 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c1d:	6a 4d                	push   $0x4d
  jmp alltraps
80107c1f:	e9 98 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c26:	6a 4e                	push   $0x4e
  jmp alltraps
80107c28:	e9 8f f6 ff ff       	jmp    801072bc <alltraps>
...
80107c2f:	6a 4f                	push   $0x4f
  jmp alltraps
80107c31:	e9 86 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c38:	6a 50                	push   $0x50
  jmp alltraps
80107c3a:	e9 7d f6 ff ff       	jmp    801072bc <alltraps>
...
80107c41:	6a 51                	push   $0x51
  jmp alltraps
80107c43:	e9 74 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c4a:	6a 52                	push   $0x52
  jmp alltraps
80107c4c:	e9 6b f6 ff ff       	jmp    801072bc <alltraps>
...
80107c53:	6a 53                	push   $0x53
  jmp alltraps
80107c55:	e9 62 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c5c:	6a 54                	push   $0x54
  jmp alltraps
80107c5e:	e9 59 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c65:	6a 55                	push   $0x55
  jmp alltraps
80107c67:	e9 50 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c6e:	6a 56                	push   $0x56
  jmp alltraps
80107c70:	e9 47 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c77:	6a 57                	push   $0x57
  jmp alltraps
80107c79:	e9 3e f6 ff ff       	jmp    801072bc <alltraps>
...
80107c80:	6a 58                	push   $0x58
  jmp alltraps
80107c82:	e9 35 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c89:	6a 59                	push   $0x59
  jmp alltraps
80107c8b:	e9 2c f6 ff ff       	jmp    801072bc <alltraps>
...
80107c92:	6a 5a                	push   $0x5a
  jmp alltraps
80107c94:	e9 23 f6 ff ff       	jmp    801072bc <alltraps>
...
80107c9b:	6a 5b                	push   $0x5b
  jmp alltraps
80107c9d:	e9 1a f6 ff ff       	jmp    801072bc <alltraps>
...
80107ca4:	6a 5c                	push   $0x5c
  jmp alltraps
80107ca6:	e9 11 f6 ff ff       	jmp    801072bc <alltraps>
...
80107cad:	6a 5d                	push   $0x5d
  jmp alltraps
80107caf:	e9 08 f6 ff ff       	jmp    801072bc <alltraps>
...
80107cb6:	6a 5e                	push   $0x5e
  jmp alltraps
80107cb8:	e9 ff f5 ff ff       	jmp    801072bc <alltraps>
...
80107cbf:	6a 5f                	push   $0x5f
  jmp alltraps
80107cc1:	e9 f6 f5 ff ff       	jmp    801072bc <alltraps>
...
80107cc8:	6a 60                	push   $0x60
  jmp alltraps
80107cca:	e9 ed f5 ff ff       	jmp    801072bc <alltraps>
...
80107cd1:	6a 61                	push   $0x61
  jmp alltraps
80107cd3:	e9 e4 f5 ff ff       	jmp    801072bc <alltraps>
...
80107cda:	6a 62                	push   $0x62
  jmp alltraps
80107cdc:	e9 db f5 ff ff       	jmp    801072bc <alltraps>
...
80107ce3:	6a 63                	push   $0x63
  jmp alltraps
80107ce5:	e9 d2 f5 ff ff       	jmp    801072bc <alltraps>
...
80107cec:	6a 64                	push   $0x64
  jmp alltraps
80107cee:	e9 c9 f5 ff ff       	jmp    801072bc <alltraps>
...
80107cf5:	6a 65                	push   $0x65
  jmp alltraps
80107cf7:	e9 c0 f5 ff ff       	jmp    801072bc <alltraps>
...
80107cfe:	6a 66                	push   $0x66
  jmp alltraps
80107d00:	e9 b7 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d07:	6a 67                	push   $0x67
  jmp alltraps
80107d09:	e9 ae f5 ff ff       	jmp    801072bc <alltraps>
...
80107d10:	6a 68                	push   $0x68
  jmp alltraps
80107d12:	e9 a5 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d19:	6a 69                	push   $0x69
  jmp alltraps
80107d1b:	e9 9c f5 ff ff       	jmp    801072bc <alltraps>
...
80107d22:	6a 6a                	push   $0x6a
  jmp alltraps
80107d24:	e9 93 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d2b:	6a 6b                	push   $0x6b
  jmp alltraps
80107d2d:	e9 8a f5 ff ff       	jmp    801072bc <alltraps>
...
80107d34:	6a 6c                	push   $0x6c
  jmp alltraps
80107d36:	e9 81 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d3d:	6a 6d                	push   $0x6d
  jmp alltraps
80107d3f:	e9 78 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d46:	6a 6e                	push   $0x6e
  jmp alltraps
80107d48:	e9 6f f5 ff ff       	jmp    801072bc <alltraps>
...
80107d4f:	6a 6f                	push   $0x6f
  jmp alltraps
80107d51:	e9 66 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d58:	6a 70                	push   $0x70
  jmp alltraps
80107d5a:	e9 5d f5 ff ff       	jmp    801072bc <alltraps>
...
80107d61:	6a 71                	push   $0x71
  jmp alltraps
80107d63:	e9 54 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d6a:	6a 72                	push   $0x72
  jmp alltraps
80107d6c:	e9 4b f5 ff ff       	jmp    801072bc <alltraps>
...
80107d73:	6a 73                	push   $0x73
  jmp alltraps
80107d75:	e9 42 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d7c:	6a 74                	push   $0x74
  jmp alltraps
80107d7e:	e9 39 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d85:	6a 75                	push   $0x75
  jmp alltraps
80107d87:	e9 30 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d8e:	6a 76                	push   $0x76
  jmp alltraps
80107d90:	e9 27 f5 ff ff       	jmp    801072bc <alltraps>
...
80107d97:	6a 77                	push   $0x77
  jmp alltraps
80107d99:	e9 1e f5 ff ff       	jmp    801072bc <alltraps>
...
80107da0:	6a 78                	push   $0x78
  jmp alltraps
80107da2:	e9 15 f5 ff ff       	jmp    801072bc <alltraps>
...
80107da9:	6a 79                	push   $0x79
  jmp alltraps
80107dab:	e9 0c f5 ff ff       	jmp    801072bc <alltraps>
...
80107db2:	6a 7a                	push   $0x7a
  jmp alltraps
80107db4:	e9 03 f5 ff ff       	jmp    801072bc <alltraps>
...
80107dbb:	6a 7b                	push   $0x7b
  jmp alltraps
80107dbd:	e9 fa f4 ff ff       	jmp    801072bc <alltraps>
...
80107dc4:	6a 7c                	push   $0x7c
  jmp alltraps
80107dc6:	e9 f1 f4 ff ff       	jmp    801072bc <alltraps>
...
80107dcd:	6a 7d                	push   $0x7d
  jmp alltraps
80107dcf:	e9 e8 f4 ff ff       	jmp    801072bc <alltraps>
...
80107dd6:	6a 7e                	push   $0x7e
  jmp alltraps
80107dd8:	e9 df f4 ff ff       	jmp    801072bc <alltraps>
...
80107ddf:	6a 7f                	push   $0x7f
  jmp alltraps
80107de1:	e9 d6 f4 ff ff       	jmp    801072bc <alltraps>
...
80107de8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107ded:	e9 ca f4 ff ff       	jmp    801072bc <alltraps>
...
80107df4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107df9:	e9 be f4 ff ff       	jmp    801072bc <alltraps>
...
80107e00:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107e05:	e9 b2 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e0c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107e11:	e9 a6 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e18:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107e1d:	e9 9a f4 ff ff       	jmp    801072bc <alltraps>
...
80107e24:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107e29:	e9 8e f4 ff ff       	jmp    801072bc <alltraps>
...
80107e30:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107e35:	e9 82 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e3c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107e41:	e9 76 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e48:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107e4d:	e9 6a f4 ff ff       	jmp    801072bc <alltraps>
...
80107e54:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107e59:	e9 5e f4 ff ff       	jmp    801072bc <alltraps>
...
80107e60:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107e65:	e9 52 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e6c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107e71:	e9 46 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e78:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107e7d:	e9 3a f4 ff ff       	jmp    801072bc <alltraps>
...
80107e84:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107e89:	e9 2e f4 ff ff       	jmp    801072bc <alltraps>
...
80107e90:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107e95:	e9 22 f4 ff ff       	jmp    801072bc <alltraps>
...
80107e9c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107ea1:	e9 16 f4 ff ff       	jmp    801072bc <alltraps>
...
80107ea8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107ead:	e9 0a f4 ff ff       	jmp    801072bc <alltraps>
...
80107eb4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107eb9:	e9 fe f3 ff ff       	jmp    801072bc <alltraps>
...
80107ec0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107ec5:	e9 f2 f3 ff ff       	jmp    801072bc <alltraps>
...
80107ecc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107ed1:	e9 e6 f3 ff ff       	jmp    801072bc <alltraps>
...
80107ed8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107edd:	e9 da f3 ff ff       	jmp    801072bc <alltraps>
...
80107ee4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107ee9:	e9 ce f3 ff ff       	jmp    801072bc <alltraps>
...
80107ef0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107ef5:	e9 c2 f3 ff ff       	jmp    801072bc <alltraps>
...
80107efc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107f01:	e9 b6 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f08:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107f0d:	e9 aa f3 ff ff       	jmp    801072bc <alltraps>
...
80107f14:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107f19:	e9 9e f3 ff ff       	jmp    801072bc <alltraps>
...
80107f20:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107f25:	e9 92 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f2c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107f31:	e9 86 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f38:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107f3d:	e9 7a f3 ff ff       	jmp    801072bc <alltraps>
...
80107f44:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107f49:	e9 6e f3 ff ff       	jmp    801072bc <alltraps>
...
80107f50:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107f55:	e9 62 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f5c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107f61:	e9 56 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f68:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107f6d:	e9 4a f3 ff ff       	jmp    801072bc <alltraps>
...
80107f74:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107f79:	e9 3e f3 ff ff       	jmp    801072bc <alltraps>
...
80107f80:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107f85:	e9 32 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f8c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107f91:	e9 26 f3 ff ff       	jmp    801072bc <alltraps>
...
80107f98:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107f9d:	e9 1a f3 ff ff       	jmp    801072bc <alltraps>
...
80107fa4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107fa9:	e9 0e f3 ff ff       	jmp    801072bc <alltraps>
...
80107fb0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107fb5:	e9 02 f3 ff ff       	jmp    801072bc <alltraps>
...
80107fbc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107fc1:	e9 f6 f2 ff ff       	jmp    801072bc <alltraps>
...
80107fc8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107fcd:	e9 ea f2 ff ff       	jmp    801072bc <alltraps>
...
80107fd4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107fd9:	e9 de f2 ff ff       	jmp    801072bc <alltraps>
...
80107fe0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107fe5:	e9 d2 f2 ff ff       	jmp    801072bc <alltraps>
...
80107fec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107ff1:	e9 c6 f2 ff ff       	jmp    801072bc <alltraps>
...
80107ff8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107ffd:	e9 ba f2 ff ff       	jmp    801072bc <alltraps>
...
80108004:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80108009:	e9 ae f2 ff ff       	jmp    801072bc <alltraps>
...
80108010:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80108015:	e9 a2 f2 ff ff       	jmp    801072bc <alltraps>
...
8010801c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80108021:	e9 96 f2 ff ff       	jmp    801072bc <alltraps>
...
80108028:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010802d:	e9 8a f2 ff ff       	jmp    801072bc <alltraps>
...
80108034:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80108039:	e9 7e f2 ff ff       	jmp    801072bc <alltraps>
...
80108040:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80108045:	e9 72 f2 ff ff       	jmp    801072bc <alltraps>
...
8010804c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80108051:	e9 66 f2 ff ff       	jmp    801072bc <alltraps>
...
80108058:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010805d:	e9 5a f2 ff ff       	jmp    801072bc <alltraps>
...
80108064:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80108069:	e9 4e f2 ff ff       	jmp    801072bc <alltraps>
...
80108070:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80108075:	e9 42 f2 ff ff       	jmp    801072bc <alltraps>
...
8010807c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80108081:	e9 36 f2 ff ff       	jmp    801072bc <alltraps>
...
80108088:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010808d:	e9 2a f2 ff ff       	jmp    801072bc <alltraps>
...
80108094:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80108099:	e9 1e f2 ff ff       	jmp    801072bc <alltraps>
...
801080a0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801080a5:	e9 12 f2 ff ff       	jmp    801072bc <alltraps>
...
801080ac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801080b1:	e9 06 f2 ff ff       	jmp    801072bc <alltraps>
...
801080b8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801080bd:	e9 fa f1 ff ff       	jmp    801072bc <alltraps>
...
801080c4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801080c9:	e9 ee f1 ff ff       	jmp    801072bc <alltraps>
...
801080d0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801080d5:	e9 e2 f1 ff ff       	jmp    801072bc <alltraps>
...
801080dc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801080e1:	e9 d6 f1 ff ff       	jmp    801072bc <alltraps>
...
801080e8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801080ed:	e9 ca f1 ff ff       	jmp    801072bc <alltraps>
...
801080f4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801080f9:	e9 be f1 ff ff       	jmp    801072bc <alltraps>
...
80108100:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80108105:	e9 b2 f1 ff ff       	jmp    801072bc <alltraps>
...
8010810c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80108111:	e9 a6 f1 ff ff       	jmp    801072bc <alltraps>
...
80108118:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010811d:	e9 9a f1 ff ff       	jmp    801072bc <alltraps>
...
80108124:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80108129:	e9 8e f1 ff ff       	jmp    801072bc <alltraps>
...
80108130:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80108135:	e9 82 f1 ff ff       	jmp    801072bc <alltraps>
...
8010813c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80108141:	e9 76 f1 ff ff       	jmp    801072bc <alltraps>
...
80108148:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010814d:	e9 6a f1 ff ff       	jmp    801072bc <alltraps>
...
80108154:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80108159:	e9 5e f1 ff ff       	jmp    801072bc <alltraps>
...
80108160:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80108165:	e9 52 f1 ff ff       	jmp    801072bc <alltraps>
...
8010816c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80108171:	e9 46 f1 ff ff       	jmp    801072bc <alltraps>
...
80108178:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010817d:	e9 3a f1 ff ff       	jmp    801072bc <alltraps>
...
80108184:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80108189:	e9 2e f1 ff ff       	jmp    801072bc <alltraps>
...
80108190:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80108195:	e9 22 f1 ff ff       	jmp    801072bc <alltraps>
...
8010819c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801081a1:	e9 16 f1 ff ff       	jmp    801072bc <alltraps>
...
801081a8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801081ad:	e9 0a f1 ff ff       	jmp    801072bc <alltraps>
...
801081b4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801081b9:	e9 fe f0 ff ff       	jmp    801072bc <alltraps>
...
801081c0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801081c5:	e9 f2 f0 ff ff       	jmp    801072bc <alltraps>
...
801081cc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801081d1:	e9 e6 f0 ff ff       	jmp    801072bc <alltraps>
...
801081d8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801081dd:	e9 da f0 ff ff       	jmp    801072bc <alltraps>
...
801081e4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801081e9:	e9 ce f0 ff ff       	jmp    801072bc <alltraps>
...
801081f0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801081f5:	e9 c2 f0 ff ff       	jmp    801072bc <alltraps>
...
801081fc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80108201:	e9 b6 f0 ff ff       	jmp    801072bc <alltraps>
...
80108208:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010820d:	e9 aa f0 ff ff       	jmp    801072bc <alltraps>
...
80108214:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80108219:	e9 9e f0 ff ff       	jmp    801072bc <alltraps>
...
80108220:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80108225:	e9 92 f0 ff ff       	jmp    801072bc <alltraps>
...
8010822c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80108231:	e9 86 f0 ff ff       	jmp    801072bc <alltraps>
...
80108238:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010823d:	e9 7a f0 ff ff       	jmp    801072bc <alltraps>
...
80108244:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80108249:	e9 6e f0 ff ff       	jmp    801072bc <alltraps>
...
80108250:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80108255:	e9 62 f0 ff ff       	jmp    801072bc <alltraps>
...
8010825c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80108261:	e9 56 f0 ff ff       	jmp    801072bc <alltraps>
...
80108268:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010826d:	e9 4a f0 ff ff       	jmp    801072bc <alltraps>
...
80108274:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80108279:	e9 3e f0 ff ff       	jmp    801072bc <alltraps>
...
80108280:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80108285:	e9 32 f0 ff ff       	jmp    801072bc <alltraps>
...
8010828c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80108291:	e9 26 f0 ff ff       	jmp    801072bc <alltraps>
...
80108298:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010829d:	e9 1a f0 ff ff       	jmp    801072bc <alltraps>
...
801082a4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801082a9:	e9 0e f0 ff ff       	jmp    801072bc <alltraps>
...
801082b0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801082b5:	e9 02 f0 ff ff       	jmp    801072bc <alltraps>
...
801082bc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801082c1:	e9 f6 ef ff ff       	jmp    801072bc <alltraps>
...
801082c8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801082cd:	e9 ea ef ff ff       	jmp    801072bc <alltraps>
...
801082d4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801082d9:	e9 de ef ff ff       	jmp    801072bc <alltraps>
...
801082e0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801082e5:	e9 d2 ef ff ff       	jmp    801072bc <alltraps>
...
801082ec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801082f1:	e9 c6 ef ff ff       	jmp    801072bc <alltraps>
...
801082f8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801082fd:	e9 ba ef ff ff       	jmp    801072bc <alltraps>
...
80108304:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80108309:	e9 ae ef ff ff       	jmp    801072bc <alltraps>
...
80108310:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80108315:	e9 a2 ef ff ff       	jmp    801072bc <alltraps>
...
8010831c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80108321:	e9 96 ef ff ff       	jmp    801072bc <alltraps>
...
80108328:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010832d:	e9 8a ef ff ff       	jmp    801072bc <alltraps>
...
80108334:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80108339:	e9 7e ef ff ff       	jmp    801072bc <alltraps>
...
80108340:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80108345:	e9 72 ef ff ff       	jmp    801072bc <alltraps>
...
8010834c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80108351:	e9 66 ef ff ff       	jmp    801072bc <alltraps>
...
80108358:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010835d:	e9 5a ef ff ff       	jmp    801072bc <alltraps>
...
80108364:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80108369:	e9 4e ef ff ff       	jmp    801072bc <alltraps>
...
80108370:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80108375:	e9 42 ef ff ff       	jmp    801072bc <alltraps>
...
8010837c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80108381:	e9 36 ef ff ff       	jmp    801072bc <alltraps>
...
80108388:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010838d:	e9 2a ef ff ff       	jmp    801072bc <alltraps>
...
80108394:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80108399:	e9 1e ef ff ff       	jmp    801072bc <alltraps>
...
801083a0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801083a5:	e9 12 ef ff ff       	jmp    801072bc <alltraps>
...
801083ac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801083b1:	e9 06 ef ff ff       	jmp    801072bc <alltraps>
...
801083b8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801083bd:	e9 fa ee ff ff       	jmp    801072bc <alltraps>
...
801083c4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801083c9:	e9 ee ee ff ff       	jmp    801072bc <alltraps>
...
801083d0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801083d5:	e9 e2 ee ff ff       	jmp    801072bc <alltraps>
...
801083dc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801083e1:	e9 d6 ee ff ff       	jmp    801072bc <alltraps>
	...
...
801083f1:	83 e8 01             	sub    $0x1,%eax
801083f4:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801083f8:	8b 45 08             	mov    0x8(%ebp),%eax
801083fb:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801083ff:	8b 45 08             	mov    0x8(%ebp),%eax
80108402:	c1 e8 10             	shr    $0x10,%eax
80108405:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80108409:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010840c:	0f 01 10             	lgdtl  (%eax)
}
8010840f:	c9                   	leave  
80108410:	c3                   	ret    
...
8010841a:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
8010841e:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80108422:	0f 00 d8             	ltr    %ax
}
80108425:	c9                   	leave  
80108426:	c3                   	ret    
...
80108430:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80108434:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80108438:	8e e8                	mov    %eax,%gs
}
8010843a:	c9                   	leave  
8010843b:	c3                   	ret    
...
8010844a:	8b 45 08             	mov    0x8(%ebp),%eax
...
8010845a:	05 00 00 00 80       	add    $0x80000000,%eax
8010845f:	5d                   	pop    %ebp
80108460:	c3                   	ret    
...
80108465:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80108468:	e8 12 b3 ff ff       	call   8010377f <cpunum>
8010846d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80108473:	05 a0 3b 11 80       	add    $0x80113ba0,%eax
80108478:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010847b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010847e:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80108484:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108487:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
8010848d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108490:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80108494:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108497:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010849b:	83 e2 f0             	and    $0xfffffff0,%edx
8010849e:	83 ca 0a             	or     $0xa,%edx
801084a1:	88 50 7d             	mov    %dl,0x7d(%eax)
801084a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084a7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801084ab:	83 ca 10             	or     $0x10,%edx
801084ae:	88 50 7d             	mov    %dl,0x7d(%eax)
801084b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084b4:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801084b8:	83 e2 9f             	and    $0xffffff9f,%edx
801084bb:	88 50 7d             	mov    %dl,0x7d(%eax)
801084be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084c1:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801084c5:	83 ca 80             	or     $0xffffff80,%edx
801084c8:	88 50 7d             	mov    %dl,0x7d(%eax)
801084cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084ce:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801084d2:	83 ca 0f             	or     $0xf,%edx
801084d5:	88 50 7e             	mov    %dl,0x7e(%eax)
801084d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084db:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801084df:	83 e2 ef             	and    $0xffffffef,%edx
801084e2:	88 50 7e             	mov    %dl,0x7e(%eax)
801084e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084e8:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801084ec:	83 e2 df             	and    $0xffffffdf,%edx
801084ef:	88 50 7e             	mov    %dl,0x7e(%eax)
801084f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084f5:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801084f9:	83 ca 40             	or     $0x40,%edx
801084fc:	88 50 7e             	mov    %dl,0x7e(%eax)
801084ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108502:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108506:	83 ca 80             	or     $0xffffff80,%edx
80108509:	88 50 7e             	mov    %dl,0x7e(%eax)
8010850c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010850f:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108516:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
8010851d:	ff ff 
8010851f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108522:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80108529:	00 00 
8010852b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010852e:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80108535:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108538:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010853f:	83 e2 f0             	and    $0xfffffff0,%edx
80108542:	83 ca 02             	or     $0x2,%edx
80108545:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010854b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010854e:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108555:	83 ca 10             	or     $0x10,%edx
80108558:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010855e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108561:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108568:	83 e2 9f             	and    $0xffffff9f,%edx
8010856b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108571:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108574:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010857b:	83 ca 80             	or     $0xffffff80,%edx
8010857e:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108584:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108587:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010858e:	83 ca 0f             	or     $0xf,%edx
80108591:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108597:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010859a:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801085a1:	83 e2 ef             	and    $0xffffffef,%edx
801085a4:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801085aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085ad:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801085b4:	83 e2 df             	and    $0xffffffdf,%edx
801085b7:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801085bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085c0:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801085c7:	83 ca 40             	or     $0x40,%edx
801085ca:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801085d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085d3:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801085da:	83 ca 80             	or     $0xffffff80,%edx
801085dd:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801085e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085e6:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801085ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085f0:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801085f7:	ff ff 
801085f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085fc:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80108603:	00 00 
80108605:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108608:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010860f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108612:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108619:	83 e2 f0             	and    $0xfffffff0,%edx
8010861c:	83 ca 0a             	or     $0xa,%edx
8010861f:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108625:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108628:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010862f:	83 ca 10             	or     $0x10,%edx
80108632:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108638:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010863b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108642:	83 ca 60             	or     $0x60,%edx
80108645:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010864b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010864e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108655:	83 ca 80             	or     $0xffffff80,%edx
80108658:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010865e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108661:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108668:	83 ca 0f             	or     $0xf,%edx
8010866b:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108671:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108674:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010867b:	83 e2 ef             	and    $0xffffffef,%edx
8010867e:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108684:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108687:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010868e:	83 e2 df             	and    $0xffffffdf,%edx
80108691:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108697:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010869a:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801086a1:	83 ca 40             	or     $0x40,%edx
801086a4:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801086aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086ad:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801086b4:	83 ca 80             	or     $0xffffff80,%edx
801086b7:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801086bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086c0:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801086c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086ca:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801086d1:	ff ff 
801086d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086d6:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801086dd:	00 00 
801086df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086e2:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801086e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086ec:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801086f3:	83 e2 f0             	and    $0xfffffff0,%edx
801086f6:	83 ca 02             	or     $0x2,%edx
801086f9:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801086ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108702:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108709:	83 ca 10             	or     $0x10,%edx
8010870c:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108712:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108715:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010871c:	83 ca 60             	or     $0x60,%edx
8010871f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108725:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108728:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010872f:	83 ca 80             	or     $0xffffff80,%edx
80108732:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108738:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010873b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108742:	83 ca 0f             	or     $0xf,%edx
80108745:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010874b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010874e:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108755:	83 e2 ef             	and    $0xffffffef,%edx
80108758:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010875e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108761:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108768:	83 e2 df             	and    $0xffffffdf,%edx
8010876b:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108771:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108774:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010877b:	83 ca 40             	or     $0x40,%edx
8010877e:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108784:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108787:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010878e:	83 ca 80             	or     $0xffffff80,%edx
80108791:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108797:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010879a:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801087a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087a4:	05 b4 00 00 00       	add    $0xb4,%eax
801087a9:	89 c3                	mov    %eax,%ebx
801087ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087ae:	05 b4 00 00 00       	add    $0xb4,%eax
801087b3:	c1 e8 10             	shr    $0x10,%eax
801087b6:	89 c1                	mov    %eax,%ecx
801087b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087bb:	05 b4 00 00 00       	add    $0xb4,%eax
801087c0:	c1 e8 18             	shr    $0x18,%eax
801087c3:	89 c2                	mov    %eax,%edx
801087c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087c8:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801087cf:	00 00 
801087d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087d4:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801087db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087de:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801087e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087e7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801087ee:	83 e1 f0             	and    $0xfffffff0,%ecx
801087f1:	83 c9 02             	or     $0x2,%ecx
801087f4:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801087fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087fd:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108804:	83 c9 10             	or     $0x10,%ecx
80108807:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010880d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108810:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108817:	83 e1 9f             	and    $0xffffff9f,%ecx
8010881a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108820:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108823:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010882a:	83 c9 80             	or     $0xffffff80,%ecx
8010882d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108833:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108836:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010883d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108840:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108846:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108849:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108850:	83 e1 ef             	and    $0xffffffef,%ecx
80108853:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108859:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010885c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108863:	83 e1 df             	and    $0xffffffdf,%ecx
80108866:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010886c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010886f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108876:	83 c9 40             	or     $0x40,%ecx
80108879:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010887f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108882:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108889:	83 c9 80             	or     $0xffffff80,%ecx
8010888c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108892:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108895:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
8010889b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010889e:	83 c0 70             	add    $0x70,%eax
801088a1:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801088a8:	00 
801088a9:	89 04 24             	mov    %eax,(%esp)
801088ac:	e8 37 fb ff ff       	call   801083e8 <lgdt>
  loadgs(SEG_KCPU << 3);
801088b1:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801088b8:	e8 6a fb ff ff       	call   80108427 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801088bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088c0:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801088c6:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801088cd:	00 00 00 00 
}
801088d1:	83 c4 24             	add    $0x24,%esp
801088d4:	5b                   	pop    %ebx
801088d5:	5d                   	pop    %ebp
801088d6:	c3                   	ret    
...
801088e0:	c1 e8 16             	shr    $0x16,%eax
801088e3:	c1 e0 02             	shl    $0x2,%eax
801088e6:	03 45 08             	add    0x8(%ebp),%eax
801088e9:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801088ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088ef:	8b 00                	mov    (%eax),%eax
801088f1:	83 e0 01             	and    $0x1,%eax
801088f4:	84 c0                	test   %al,%al
801088f6:	74 17                	je     8010890f <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
801088f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088fb:	8b 00                	mov    (%eax),%eax
801088fd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108902:	89 04 24             	mov    %eax,(%esp)
80108905:	e8 4a fb ff ff       	call   80108454 <p2v>
8010890a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010890d:	eb 4b                	jmp    8010895a <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010890f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108913:	74 0e                	je     80108923 <walkpgdir+0x4c>
80108915:	e8 ad aa ff ff       	call   801033c7 <kalloc>
8010891a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010891d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108921:	75 07                	jne    8010892a <walkpgdir+0x53>
      return 0;
80108923:	b8 00 00 00 00       	mov    $0x0,%eax
80108928:	eb 41                	jmp    8010896b <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010892a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108931:	00 
80108932:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108939:	00 
8010893a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010893d:	89 04 24             	mov    %eax,(%esp)
80108940:	e8 a1 d4 ff ff       	call   80105de6 <memset>
...
8010894b:	e8 f7 fa ff ff       	call   80108447 <v2p>
80108950:	89 c2                	mov    %eax,%edx
80108952:	83 ca 07             	or     $0x7,%edx
80108955:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108958:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
8010895a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010895d:	c1 e8 0c             	shr    $0xc,%eax
80108960:	25 ff 03 00 00       	and    $0x3ff,%eax
80108965:	c1 e0 02             	shl    $0x2,%eax
80108968:	03 45 f4             	add    -0xc(%ebp),%eax
}
8010896b:	c9                   	leave  
8010896c:	c3                   	ret    
...
80108970:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
8010897e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108981:	03 45 10             	add    0x10(%ebp),%eax
80108984:	83 e8 01             	sub    $0x1,%eax
80108987:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010898c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010898f:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108996:	00 
80108997:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010899a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010899e:	8b 45 08             	mov    0x8(%ebp),%eax
801089a1:	89 04 24             	mov    %eax,(%esp)
801089a4:	e8 2e ff ff ff       	call   801088d7 <walkpgdir>
801089a9:	89 45 ec             	mov    %eax,-0x14(%ebp)
801089ac:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801089b0:	75 07                	jne    801089b9 <mappages+0x4c>
      return -1;
801089b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801089b7:	eb 46                	jmp    801089ff <mappages+0x92>
    if(*pte & PTE_P)
801089b9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089bc:	8b 00                	mov    (%eax),%eax
801089be:	83 e0 01             	and    $0x1,%eax
801089c1:	84 c0                	test   %al,%al
801089c3:	74 0c                	je     801089d1 <mappages+0x64>
      panic("remap");
801089c5:	c7 04 24 60 98 10 80 	movl   $0x80109860,(%esp)
801089cc:	e8 6c 7b ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801089d1:	8b 45 18             	mov    0x18(%ebp),%eax
801089d4:	0b 45 14             	or     0x14(%ebp),%eax
801089d7:	89 c2                	mov    %eax,%edx
801089d9:	83 ca 01             	or     $0x1,%edx
801089dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089df:	89 10                	mov    %edx,(%eax)
    if(a == last)
801089e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089e4:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801089e7:	74 10                	je     801089f9 <mappages+0x8c>
      break;
    a += PGSIZE;
801089e9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801089f0:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801089f7:	eb 96                	jmp    8010898f <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108a08:	e8 ba a9 ff ff       	call   801033c7 <kalloc>
...
80108a36:	e8 ab d3 ff ff       	call   80105de6 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108a3b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108a42:	e8 0d fa ff ff       	call   80108454 <p2v>
80108a47:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108a4c:	76 0c                	jbe    80108a5a <setupkvm+0x59>
    panic("PHYSTOP too high");
80108a4e:	c7 04 24 66 98 10 80 	movl   $0x80109866,(%esp)
80108a55:	e8 e3 7a ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108a5a:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
...
80108a98:	e8 d0 fe ff ff       	call   8010896d <mappages>
...
80108aac:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
...
80108ac9:	a3 78 6e 11 80       	mov    %eax,0x80116e78
  switchkvm();
...
80108adb:	a1 78 6e 11 80       	mov    0x80116e78,%eax
80108ae0:	89 04 24             	mov    %eax,(%esp)
80108ae3:	e8 5f f9 ff ff       	call   80108447 <v2p>
80108ae8:	89 04 24             	mov    %eax,(%esp)
80108aeb:	e8 4c f9 ff ff       	call   8010843c <lcr3>
}
80108af0:	c9                   	leave  
80108af1:	c3                   	ret    
...
80108af6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108af9:	e8 e1 d1 ff ff       	call   80105cdf <pushcli>
...
80108c1d:	e8 ef f7 ff ff       	call   80108411 <ltr>
  if(p->pgdir == 0)
...
80108c2c:	c7 04 24 77 98 10 80 	movl   $0x80109877,(%esp)
80108c33:	e8 05 79 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108c38:	8b 45 08             	mov    0x8(%ebp),%eax
80108c3b:	8b 40 04             	mov    0x4(%eax),%eax
80108c3e:	89 04 24             	mov    %eax,(%esp)
80108c41:	e8 01 f8 ff ff       	call   80108447 <v2p>
80108c46:	89 04 24             	mov    %eax,(%esp)
80108c49:	e8 ee f7 ff ff       	call   8010843c <lcr3>
  popcli();
80108c4e:	e8 d4 d0 ff ff       	call   80105d27 <popcli>
}
...
80108c68:	c7 04 24 8b 98 10 80 	movl   $0x8010988b,(%esp)
80108c6f:	e8 c9 78 ff ff       	call   8010053d <panic>
  mem = kalloc();
80108c74:	e8 4e a7 ff ff       	call   801033c7 <kalloc>
...
80108c92:	e8 4f d1 ff ff       	call   80105de6 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108c97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c9a:	89 04 24             	mov    %eax,(%esp)
80108c9d:	e8 a5 f7 ff ff       	call   80108447 <v2p>
...
80108cc4:	e8 a4 fc ff ff       	call   8010896d <mappages>
  memmove(mem, init, sz);
...
80108cdd:	e8 d7 d1 ff ff       	call   80105eb9 <memmove>
}
80108ce2:	c9                   	leave  
80108ce3:	c3                   	ret    
...
80108cf7:	c7 04 24 a8 98 10 80 	movl   $0x801098a8,(%esp)
80108cfe:	e8 3a 78 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108d03:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108d0a:	e9 ad 00 00 00       	jmp    80108dbc <loaduvm+0xd8>
...
80108d29:	e8 a9 fb ff ff       	call   801088d7 <walkpgdir>
80108d2e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108d31:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108d35:	75 0c                	jne    80108d43 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108d37:	c7 04 24 cb 98 10 80 	movl   $0x801098cb,(%esp)
80108d3e:	e8 fa 77 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80108d56:	89 d1                	mov    %edx,%ecx
80108d58:	29 c1                	sub    %eax,%ecx
80108d5a:	89 c8                	mov    %ecx,%eax
80108d5c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108d61:	77 11                	ja     80108d74 <loaduvm+0x90>
      n = sz - i;
80108d63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d66:	8b 55 18             	mov    0x18(%ebp),%edx
80108d69:	89 d1                	mov    %edx,%ecx
80108d6b:	29 c1                	sub    %eax,%ecx
80108d6d:	89 c8                	mov    %ecx,%eax
80108d6f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108d72:	eb 07                	jmp    80108d7b <loaduvm+0x97>
    else
      n = PGSIZE;
80108d74:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108d7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d7e:	8b 55 14             	mov    0x14(%ebp),%edx
80108d81:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108d84:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108d87:	89 04 24             	mov    %eax,(%esp)
80108d8a:	e8 c5 f6 ff ff       	call   80108454 <p2v>
80108d8f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108d92:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108d96:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108d9a:	89 44 24 04          	mov    %eax,0x4(%esp)
80108d9e:	8b 45 10             	mov    0x10(%ebp),%eax
80108da1:	89 04 24             	mov    %eax,(%esp)
80108da4:	e8 48 98 ff ff       	call   801025f1 <readi>
80108da9:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108dac:	74 07                	je     80108db5 <loaduvm+0xd1>
      return -1;
80108dae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108db3:	eb 18                	jmp    80108dcd <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80108db5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108dbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108dbf:	3b 45 18             	cmp    0x18(%ebp),%eax
80108dc2:	0f 82 47 ff ff ff    	jb     80108d0f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108dcd:	83 c4 24             	add    $0x24,%esp
80108dd0:	5b                   	pop    %ebx
80108dd1:	5d                   	pop    %ebp
80108dd2:	c3                   	ret    
...
80108dd6:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
80108dd9:	8b 45 10             	mov    0x10(%ebp),%eax
80108ddc:	85 c0                	test   %eax,%eax
80108dde:	79 0a                	jns    80108dea <allocuvm+0x17>
    return 0;
80108de0:	b8 00 00 00 00       	mov    $0x0,%eax
80108de5:	e9 c1 00 00 00       	jmp    80108eab <allocuvm+0xd8>
  if(newsz < oldsz)
80108dea:	8b 45 10             	mov    0x10(%ebp),%eax
80108ded:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108df0:	73 08                	jae    80108dfa <allocuvm+0x27>
    return oldsz;
80108df2:	8b 45 0c             	mov    0xc(%ebp),%eax
80108df5:	e9 b1 00 00 00       	jmp    80108eab <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108dfa:	8b 45 0c             	mov    0xc(%ebp),%eax
80108dfd:	05 ff 0f 00 00       	add    $0xfff,%eax
80108e02:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108e07:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108e0a:	e9 8d 00 00 00       	jmp    80108e9c <allocuvm+0xc9>
    mem = kalloc();
80108e0f:	e8 b3 a5 ff ff       	call   801033c7 <kalloc>
80108e14:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108e17:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108e1b:	75 2c                	jne    80108e49 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108e1d:	c7 04 24 e9 98 10 80 	movl   $0x801098e9,(%esp)
80108e24:	e8 78 75 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108e29:	8b 45 0c             	mov    0xc(%ebp),%eax
80108e2c:	89 44 24 08          	mov    %eax,0x8(%esp)
80108e30:	8b 45 10             	mov    0x10(%ebp),%eax
80108e33:	89 44 24 04          	mov    %eax,0x4(%esp)
80108e37:	8b 45 08             	mov    0x8(%ebp),%eax
80108e3a:	89 04 24             	mov    %eax,(%esp)
80108e3d:	e8 6b 00 00 00       	call   80108ead <deallocuvm>
      return 0;
80108e42:	b8 00 00 00 00       	mov    $0x0,%eax
80108e47:	eb 62                	jmp    80108eab <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108e49:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108e50:	00 
80108e51:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108e58:	00 
80108e59:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108e5c:	89 04 24             	mov    %eax,(%esp)
80108e5f:	e8 82 cf ff ff       	call   80105de6 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108e64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108e67:	89 04 24             	mov    %eax,(%esp)
80108e6a:	e8 d8 f5 ff ff       	call   80108447 <v2p>
80108e6f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108e72:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108e79:	00 
80108e7a:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108e7e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108e85:	00 
80108e86:	89 54 24 04          	mov    %edx,0x4(%esp)
80108e8a:	8b 45 08             	mov    0x8(%ebp),%eax
80108e8d:	89 04 24             	mov    %eax,(%esp)
80108e90:	e8 d8 fa ff ff       	call   8010896d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108e95:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108e9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e9f:	3b 45 10             	cmp    0x10(%ebp),%eax
80108ea2:	0f 82 67 ff ff ff    	jb     80108e0f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
{
80108ead:	55                   	push   %ebp
80108eae:	89 e5                	mov    %esp,%ebp
80108eb0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80108eb3:	8b 45 10             	mov    0x10(%ebp),%eax
80108eb6:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108eb9:	72 08                	jb     80108ec3 <deallocuvm+0x16>
    return oldsz;
80108ebb:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ebe:	e9 a4 00 00 00       	jmp    80108f67 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108ec3:	8b 45 10             	mov    0x10(%ebp),%eax
80108ec6:	05 ff 0f 00 00       	add    $0xfff,%eax
80108ecb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108ed0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108ed3:	e9 80 00 00 00       	jmp    80108f58 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108ed8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108edb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ee2:	00 
80108ee3:	89 44 24 04          	mov    %eax,0x4(%esp)
80108ee7:	8b 45 08             	mov    0x8(%ebp),%eax
80108eea:	89 04 24             	mov    %eax,(%esp)
80108eed:	e8 e5 f9 ff ff       	call   801088d7 <walkpgdir>
80108ef2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108ef5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108ef9:	75 09                	jne    80108f04 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108efb:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108f02:	eb 4d                	jmp    80108f51 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108f04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108f07:	8b 00                	mov    (%eax),%eax
80108f09:	83 e0 01             	and    $0x1,%eax
80108f0c:	84 c0                	test   %al,%al
80108f0e:	74 41                	je     80108f51 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108f10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108f13:	8b 00                	mov    (%eax),%eax
80108f15:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108f1a:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108f1d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108f21:	75 0c                	jne    80108f2f <deallocuvm+0x82>
        panic("kfree");
80108f23:	c7 04 24 01 99 10 80 	movl   $0x80109901,(%esp)
80108f2a:	e8 0e 76 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108f2f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108f32:	89 04 24             	mov    %eax,(%esp)
80108f35:	e8 1a f5 ff ff       	call   80108454 <p2v>
80108f3a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108f3d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108f40:	89 04 24             	mov    %eax,(%esp)
80108f43:	e8 e6 a3 ff ff       	call   8010332e <kfree>
      *pte = 0;
...
80108f4b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108f51:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108f58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f5b:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108f5e:	0f 82 74 ff ff ff    	jb     80108ed8 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
80108f64:	8b 45 10             	mov    0x10(%ebp),%eax
}
80108f67:	c9                   	leave  
80108f68:	c3                   	ret    
...
80108f6c:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108f6f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108f73:	75 0c                	jne    80108f81 <freevm+0x18>
    panic("freevm: no pgdir");
80108f75:	c7 04 24 07 99 10 80 	movl   $0x80109907,(%esp)
80108f7c:	e8 bc 75 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108f81:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108f88:	00 
80108f89:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108f90:	80 
80108f91:	8b 45 08             	mov    0x8(%ebp),%eax
80108f94:	89 04 24             	mov    %eax,(%esp)
80108f97:	e8 11 ff ff ff       	call   80108ead <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108f9c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108fa3:	eb 3c                	jmp    80108fe1 <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108fa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108fa8:	c1 e0 02             	shl    $0x2,%eax
80108fab:	03 45 08             	add    0x8(%ebp),%eax
80108fae:	8b 00                	mov    (%eax),%eax
80108fb0:	83 e0 01             	and    $0x1,%eax
80108fb3:	84 c0                	test   %al,%al
80108fb5:	74 26                	je     80108fdd <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108fb7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108fba:	c1 e0 02             	shl    $0x2,%eax
80108fbd:	03 45 08             	add    0x8(%ebp),%eax
80108fc0:	8b 00                	mov    (%eax),%eax
80108fc2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108fc7:	89 04 24             	mov    %eax,(%esp)
80108fca:	e8 85 f4 ff ff       	call   80108454 <p2v>
80108fcf:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108fd2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108fd5:	89 04 24             	mov    %eax,(%esp)
80108fd8:	e8 51 a3 ff ff       	call   8010332e <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108fdd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108fe1:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108fe8:	76 bb                	jbe    80108fa5 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108ff0:	e8 39 a3 ff ff       	call   8010332e <kfree>
}
80108ff5:	c9                   	leave  
80108ff6:	c3                   	ret    
...
80108ffa:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108ffd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109004:	00 
80109005:	8b 45 0c             	mov    0xc(%ebp),%eax
80109008:	89 44 24 04          	mov    %eax,0x4(%esp)
8010900c:	8b 45 08             	mov    0x8(%ebp),%eax
8010900f:	89 04 24             	mov    %eax,(%esp)
80109012:	e8 c0 f8 ff ff       	call   801088d7 <walkpgdir>
80109017:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010901a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010901e:	75 0c                	jne    8010902c <clearpteu+0x35>
    panic("clearpteu");
80109020:	c7 04 24 18 99 10 80 	movl   $0x80109918,(%esp)
80109027:	e8 11 75 ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
8010902c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010902f:	8b 00                	mov    (%eax),%eax
80109031:	89 c2                	mov    %eax,%edx
80109033:	83 e2 fb             	and    $0xfffffffb,%edx
...
80109040:	53                   	push   %ebx
80109041:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80109044:	e8 b8 f9 ff ff       	call   80108a01 <setupkvm>
80109049:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010904c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80109050:	75 0a                	jne    8010905c <copyuvm+0x1f>
    return 0;
80109052:	b8 00 00 00 00       	mov    $0x0,%eax
80109057:	e9 fd 00 00 00       	jmp    80109159 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
8010905c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80109063:	e9 cc 00 00 00       	jmp    80109134 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80109068:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010906b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109072:	00 
80109073:	89 44 24 04          	mov    %eax,0x4(%esp)
80109077:	8b 45 08             	mov    0x8(%ebp),%eax
8010907a:	89 04 24             	mov    %eax,(%esp)
8010907d:	e8 55 f8 ff ff       	call   801088d7 <walkpgdir>
80109082:	89 45 ec             	mov    %eax,-0x14(%ebp)
80109085:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80109089:	75 0c                	jne    80109097 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
8010908b:	c7 04 24 22 99 10 80 	movl   $0x80109922,(%esp)
80109092:	e8 a6 74 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80109097:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010909a:	8b 00                	mov    (%eax),%eax
8010909c:	83 e0 01             	and    $0x1,%eax
8010909f:	85 c0                	test   %eax,%eax
801090a1:	75 0c                	jne    801090af <copyuvm+0x72>
      panic("copyuvm: page not present");
801090a3:	c7 04 24 3c 99 10 80 	movl   $0x8010993c,(%esp)
...
801090c1:	25 ff 0f 00 00       	and    $0xfff,%eax
801090c6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801090c9:	e8 f9 a2 ff ff       	call   801033c7 <kalloc>
801090ce:	89 45 e0             	mov    %eax,-0x20(%ebp)
801090d1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801090d5:	74 6e                	je     80109145 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801090d7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801090da:	89 04 24             	mov    %eax,(%esp)
801090dd:	e8 72 f3 ff ff       	call   80108454 <p2v>
801090e2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801090e9:	00 
801090ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801090ee:	8b 45 e0             	mov    -0x20(%ebp),%eax
801090f1:	89 04 24             	mov    %eax,(%esp)
801090f4:	e8 c0 cd ff ff       	call   80105eb9 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801090f9:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801090fc:	8b 45 e0             	mov    -0x20(%ebp),%eax
801090ff:	89 04 24             	mov    %eax,(%esp)
80109102:	e8 40 f3 ff ff       	call   80108447 <v2p>
80109107:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010910a:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010910e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80109112:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109119:	00 
8010911a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010911e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109121:	89 04 24             	mov    %eax,(%esp)
80109124:	e8 44 f8 ff ff       	call   8010896d <mappages>
80109129:	85 c0                	test   %eax,%eax
8010912b:	78 1b                	js     80109148 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010912d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80109134:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109137:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010913a:	0f 82 28 ff ff ff    	jb     80109068 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80109143:	eb 14                	jmp    80109159 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80109145:	90                   	nop
80109146:	eb 01                	jmp    80109149 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80109148:	90                   	nop
...
8010914c:	89 04 24             	mov    %eax,(%esp)
8010914f:	e8 15 fe ff ff       	call   80108f69 <freevm>
  return 0;
80109154:	b8 00 00 00 00       	mov    $0x0,%eax
}
80109159:	83 c4 44             	add    $0x44,%esp
8010915c:	5b                   	pop    %ebx
8010915d:	5d                   	pop    %ebp
8010915e:	c3                   	ret    
...
80109162:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80109165:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010916c:	00 
8010916d:	8b 45 0c             	mov    0xc(%ebp),%eax
80109170:	89 44 24 04          	mov    %eax,0x4(%esp)
80109174:	8b 45 08             	mov    0x8(%ebp),%eax
80109177:	89 04 24             	mov    %eax,(%esp)
8010917a:	e8 58 f7 ff ff       	call   801088d7 <walkpgdir>
8010917f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80109182:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109185:	8b 00                	mov    (%eax),%eax
80109187:	83 e0 01             	and    $0x1,%eax
8010918a:	85 c0                	test   %eax,%eax
8010918c:	75 07                	jne    80109195 <uva2ka+0x36>
    return 0;
8010918e:	b8 00 00 00 00       	mov    $0x0,%eax
80109193:	eb 25                	jmp    801091ba <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80109195:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109198:	8b 00                	mov    (%eax),%eax
8010919a:	83 e0 04             	and    $0x4,%eax
8010919d:	85 c0                	test   %eax,%eax
8010919f:	75 07                	jne    801091a8 <uva2ka+0x49>
    return 0;
801091a1:	b8 00 00 00 00       	mov    $0x0,%eax
801091a6:	eb 12                	jmp    801091ba <uva2ka+0x5b>
...
801091b5:	e8 9a f2 ff ff       	call   80108454 <p2v>
}
801091ba:	c9                   	leave  
801091bb:	c3                   	ret    
...
{
801091bc:	55                   	push   %ebp
801091bd:	89 e5                	mov    %esp,%ebp
801091bf:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
801091c2:	8b 45 10             	mov    0x10(%ebp),%eax
801091c5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801091c8:	e9 8b 00 00 00       	jmp    80109258 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
801091cd:	8b 45 0c             	mov    0xc(%ebp),%eax
801091d0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801091d5:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
801091d8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801091db:	89 44 24 04          	mov    %eax,0x4(%esp)
801091df:	8b 45 08             	mov    0x8(%ebp),%eax
801091e2:	89 04 24             	mov    %eax,(%esp)
801091e5:	e8 75 ff ff ff       	call   8010915f <uva2ka>
801091ea:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801091ed:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801091f1:	75 07                	jne    801091fa <copyout+0x3e>
      return -1;
801091f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801091f8:	eb 6d                	jmp    80109267 <copyout+0xab>
    n = PGSIZE - (va - va0);
801091fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801091fd:	8b 55 ec             	mov    -0x14(%ebp),%edx
80109200:	89 d1                	mov    %edx,%ecx
80109202:	29 c1                	sub    %eax,%ecx
80109204:	89 c8                	mov    %ecx,%eax
80109206:	05 00 10 00 00       	add    $0x1000,%eax
8010920b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
8010920e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109211:	3b 45 14             	cmp    0x14(%ebp),%eax
80109214:	76 06                	jbe    8010921c <copyout+0x60>
      n = len;
80109216:	8b 45 14             	mov    0x14(%ebp),%eax
80109219:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010921c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010921f:	8b 55 0c             	mov    0xc(%ebp),%edx
80109222:	89 d1                	mov    %edx,%ecx
80109224:	29 c1                	sub    %eax,%ecx
80109226:	89 c8                	mov    %ecx,%eax
80109228:	03 45 e8             	add    -0x18(%ebp),%eax
8010922b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010922e:	89 54 24 08          	mov    %edx,0x8(%esp)
80109232:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109235:	89 54 24 04          	mov    %edx,0x4(%esp)
80109239:	89 04 24             	mov    %eax,(%esp)
8010923c:	e8 78 cc ff ff       	call   80105eb9 <memmove>
    len -= n;
80109241:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109244:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80109247:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010924a:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
8010924d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109250:	05 00 10 00 00       	add    $0x1000,%eax
80109255:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80109258:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010925c:	0f 85 6b ff ff ff    	jne    801091cd <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  ...
  return 0;
80109262:	b8 00 00 00 00       	mov    $0x0,%eax
}
80109267:	c9                   	leave  
80109268:	c3                   	ret    
